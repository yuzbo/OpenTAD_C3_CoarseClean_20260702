...
class Collect:
    def __init__(
        ...
        meta_keys=[
            ...
            "irregular_sampling_scope",
            "phystime_raw_observation_count",
            "phystime_raw_valid_count",
            "phystime_raw_selected_dense_indices",
            "phystime_native_token_count",
            "phystime_native_valid_count",
            "phystime_native_tubelet_size",
            "phystime_native_chunk_size",
            "phystime_native_attention_chunk_token_count",
            "phystime_native_transformer_depth",
            "phystime_native_adapter_indices",
            "phystime_native_adapter_kernel_size",
            "phystime_native_adapter_dilation",
            "phystime_native_coordinate_mode",
            "phystime_native_token_dense_positions",
            "phystime_native_token_timestamps_sec",
            "phystime_patch_embed_support_atoms_sec",
            "phystime_patch_embed_dense_atoms",
            "phystime_patch_embed_raw_frame_atoms",
            "phystime_patch_embed_semantic_atom_mask",
            "phystime_patch_embed_compute_atom_mask",
            "phystime_patch_embed_atom_kind",
            "phystime_patch_embed_support_envelopes_sec",
            "phystime_patch_embed_envelope_inflation_sec",
            "phystime_patch_embed_atom_gap_sec",
            "phystime_patch_embed_padding_repeat_count",
            "phystime_patch_embed_lineage_provenance",
            "phystime_native_final_feature_lineage",
            "phystime_native_final_feature_token_ranges_exclusive",
            "phystime_native_final_feature_raw_slot_ranges_exclusive",
            "phystime_native_final_feature_raw_slot_upper_bound",
            "phystime_native_final_feature_support_is_exact",
            "phystime_native_final_feature_valid_tokens_may_depend_on_padding_repeats",
            "phystime_native_final_feature_padding_dependency_upper_bound_mask",
            "phystime_canonical_fps",
            "phystime_canonical_fps_source",
            "phystime_decoder_avg_fps",
            "phystime_decoder_total_frames",
            "phystime_fps_relative_error",
            "phystime_duration_relative_error",
            "phystime_frame_count_relative_error",
            "phystime_timebase_tolerance_policy",
