...
LOG=/data/run01/sczc063/yuzibo/projects/phystime_tad/runs/diagnostic_closure_linux_preflight_20260730_v13.log

test -d "${RUNTIME}"
test ! -e "${LOG}"
test "$(git -C "${RUNTIME}" rev-parse HEAD)" = e7a31c4f1d79eedf9672409571871db9e3e5fca9
test "$(git -C "${RUNTIME}" rev-parse "HEAD^{tree}")" = 41bbae08262e78066dc9a25b97c281f1fee38351
