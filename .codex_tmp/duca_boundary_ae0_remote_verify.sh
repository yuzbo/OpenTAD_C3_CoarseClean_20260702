...
SNAP="$BASE/projects/opentad_duca_boundary_ae0bc73_20260722"
COMMIT=ae0bc735b13c2d12ac6e504445308f45010a6ab2
...
REPLAY_ROOT="$BASE/tmp/duca_r0_determinism_ae0bc73_20260722"
test ! -e "$REPLAY_ROOT"
...
printf 'REMOTE_AE0_VERIFY_PASS commit=%s replay_root=%s\n' "$COMMIT" "$REPLAY_ROOT"
