...
LOG=/data/run01/sczc063/yuzibo/projects/phystime_tad/runs/diagnostic_closure_linux_preflight_20260730_v15.log

test -d "${RUNTIME}"
test ! -e "${LOG}"
test "$(git -C "${RUNTIME}" rev-parse HEAD)" = a88befdf105b794d540fa13160641e7fb6294a8b
test "$(git -C "${RUNTIME}" rev-parse "HEAD^{tree}")" = e1f1cfd36cb86ef04a73b04482440fd5fcc66842
