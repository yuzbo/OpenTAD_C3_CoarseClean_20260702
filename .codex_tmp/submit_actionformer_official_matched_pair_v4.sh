...
run_root="/data/run01/sczc063/yuzibo/projects/phystime_tad/runs/actionformer_official_matched_pair_k384_seed1234567891_20260730_v4"
launcher="/data/run01/sczc063/yuzibo/projects/opentad_sparsehead_diagnostic_closure_20260729_v27/scripts/run_actionformer_official_matched_pair_n16r4.sbatch"
test -d "$run_root"
...
export_arg+=",AUDIT_ROOT=/data/run01/sczc063/yuzibo/projects/opentad_sparsehead_diagnostic_closure_20260729_v27"
...
export_arg+=",PAIR_TAG=official_k384_seed1234567891_v4"
...
export_arg+=",EXPECTED_AUDIT_COMMIT=71f955a7301f07875a35e0be366241e548e5c775"
export_arg+=",EXPECTED_AUDIT_TREE=d328093644e040741e16dbdd8bc93b6b0d608a10"
