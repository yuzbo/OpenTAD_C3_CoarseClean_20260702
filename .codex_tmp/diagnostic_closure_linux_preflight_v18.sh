...
RUNTIME=/data/run01/sczc063/yuzibo/projects/opentad_sparsehead_diagnostic_closure_20260730_v18
LOG=/data/run01/sczc063/yuzibo/projects/phystime_tad/runs/diagnostic_closure_linux_preflight_20260730_v18.log

test -d "${RUNTIME}"
test ! -e "${LOG}"
test "$(git -C "${RUNTIME}" rev-parse HEAD)" = 8b80c98ee2af65561bf305b4fdc2ef16e460da73
test "$(git -C "${RUNTIME}" rev-parse "HEAD^{tree}")" = 148a93eac4ff1b6a3be46fdca72c705aa17294a6
