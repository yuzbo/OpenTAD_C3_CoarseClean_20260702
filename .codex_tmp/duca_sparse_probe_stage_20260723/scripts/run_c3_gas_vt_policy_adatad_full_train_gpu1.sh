...
GAS_VT_MAX_P95_UNSELECTED_HOLE="${GAS_VT_MAX_P95_UNSELECTED_HOLE:-${GAS_VT_MAX_UNSELECTED_HOLE}}"
GAS_VT_MAX_UNIFORM_SIMILARITY="${GAS_VT_MAX_UNIFORM_SIMILARITY:-0.60}"
...
run_adatad_variant() {
  ...
  echo "[C3_GAS_VT_ADATAD] train variant=${variant} master_port=${master_port} work_dir=${work_dir}"
