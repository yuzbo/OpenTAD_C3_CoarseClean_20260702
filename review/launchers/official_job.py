...
def main():
    ...
    assert cfg.workflow.val_start_epoch == 40 and cfg.workflow.val_eval_interval == 2
    ...
    save(output / 'preflight.json', dict(status='PASS', upstream_commit=binding['upstream_commit'],
         ...
         validation_start_epoch=40, validation_interval_epochs=2, checkpoint_interval_epochs=2,
