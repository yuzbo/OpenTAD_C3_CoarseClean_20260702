...
duca_online_precheck_contract = dict(
    ...
    stage="duca_online_adatad_precheck",
    detector_stack="OpenTAD_SingleStageDetector",
    actionness_source="online_probe",
...
model = dict(
    ...
    frame_selector=dict(
        ...
        actionness_source_cfg=dict(
            type="DucaOnlineProbeActionnessSource",
            source_name="duca_online_probe_actionness",
            input_channels=toy_input_channels,
...
work_dir = "exps/thumos/adatad/duca_online_adatad_precheck"
