...
duca_online_precheck_contract = dict(
    route="DUCA_ONLINE_ACTIONFORMER_NO_PHYSICAL_GRID_PRECHECK",
    stage="duca_online_actionformer_no_physical_grid_precheck",
    detector_stack="OpenTAD_ActionFormerHead_UnmodifiedTemporalAxis",
...
work_dir = "exps/thumos/adatad/duca_online_actionformer_no_physical_grid_precheck"
