...
official_bc_arm = "R3-AREA-SHIFT"
model = dict(
    backbone=dict(
        custom=dict(
            georoute_official_support="continuous_rect_dynamic_area_shift97",
            georoute_r3_soft_membership_temperature=0.025,
            georoute_r3_area_shift_tubelets=97,
        )
    )
)
...
route_topology = dict(
    ...
    area_shift="roll_width_height_by_97_tubelets_centers_unchanged", naturally_dynamic_k_t=True,
    inside_topk_or_fill_allowed=False, zero_carrier_mode="masked_zero",
...
zoomtoken_p1_config = dict(
    schema_version="zoomtoken_r234_config_v001", arm_surface="R3-AREA-SHIFT", seed=42,
    source_commit=None, runner_binding_required=True, support="continuous_rect_dynamic_area_shift97",
    support_topology="continuous_strict_rectangle_area_shift97_dynamic_k_t",
...
work_dir = "exps/thumos/adatad/georoute_official_r3_area_shift97_seed42_unbound"
