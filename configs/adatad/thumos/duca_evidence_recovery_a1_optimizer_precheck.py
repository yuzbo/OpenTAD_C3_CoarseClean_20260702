"""Two real-loader epochs for the no-coverage optimizer repair."""
_base_ = ["./duca_evidence_recovery_no_coverage.py"]
...
work_dir = "exps/thumos/adatad/duca_evidence_a1_optimizer_precheck"
