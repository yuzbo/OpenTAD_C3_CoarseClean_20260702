...
official_bc_arm = "R2-SHUF48"
model = dict(
    backbone=dict(
        custom=dict(
            georoute_official_support="strict_rect8x8_shuf48",
...
route_topology = dict(
    ...
    selected="stateless_result_blind_shuffle48_inside_candidate",
    shuffle_key=("seed", "window_ordinal", "tubelet_ordinal"),
...
zoomtoken_p1_config = dict(
    schema_version="zoomtoken_r234_config_v001", arm_surface="R2-SHUF48", seed=42,
    source_commit=None, runner_binding_required=True, support="strict_rect8x8_shuf48",
    support_topology="complete_8x8_candidate_stateless_shuffle48",
...
work_dir = "exps/thumos/adatad/georoute_official_r2_shuf48_seed42_unbound"
