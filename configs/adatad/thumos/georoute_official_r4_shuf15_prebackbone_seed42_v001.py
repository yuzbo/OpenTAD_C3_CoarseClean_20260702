...
official_bc_arm = "R4-SHUF15"
model = dict(backbone=dict(custom=dict(georoute_official_support="strict_rect7x7_core49_shuf15")))
optimizer = dict(
    backbone=dict(
        custom=[
...
route_topology = dict(
    ...
    core_tokens=49, selected_outside="stateless_result_blind_shuffle15", outside_tokens=15,
    shuffle_key=("seed", "window_ordinal", "tubelet_ordinal"), tokens_per_tubelet=64,
...
zoomtoken_p1_config = dict(
    schema_version="zoomtoken_r234_config_v001", arm_surface="R4-SHUF15", seed=42,
    source_commit=None, runner_binding_required=True, support="strict_rect7x7_core49_shuf15",
    support_topology="immutable_7x7_core49_plus_stateless_shuffle15",
...
work_dir = "exps/thumos/adatad/georoute_official_r4_shuf15_seed42_unbound"
