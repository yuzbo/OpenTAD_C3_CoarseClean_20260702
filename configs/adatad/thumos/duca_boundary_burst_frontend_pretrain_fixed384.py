...
duca_transition_only_contract = dict(
    ...
    transition_supervision_updates_coarse_representation=True,
    auxiliary_hidden_gradient_scale=0.25,
    transition_distribution_updates="asformer_last_encoder_layer_only",
    boundary_coverage_updates="asformer_last_encoder_layer_only",
