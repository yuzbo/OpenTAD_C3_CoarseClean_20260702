...
official_bc_arm = "Q48-GLOBAL"
model = dict(backbone=dict(custom=dict(georoute_official_support="q48_global", georoute_tokens_per_tubelet=48)))
optimizer = dict(
    backbone=dict(
        custom=[
...
route_topology = dict(
    source_grid_hw=(10, 10), selected="stable_q_base_top48_global",
    tokens_per_tubelet=48, q_base_roi_modifier_enabled=False,
    q_base_residual_modifier_enabled=False, q_base_geometry_side_channel_enabled=False,
...
zoomtoken_p1_config = dict(
    schema_version="zoomtoken_r234_config_v001", arm_surface="Q48-GLOBAL", seed=42,
    source_commit=None, runner_binding_required=True, support="q48_global",
    support_topology="global_q_base_top48",
...
work_dir = "exps/thumos/adatad/georoute_official_q48_global_seed42_unbound"
