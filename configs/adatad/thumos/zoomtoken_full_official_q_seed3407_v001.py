"""Q-core dynamic spatial routing on the complete official THUMOS14 split."""
...
georoute_protocol = dict(
    ...
    arm="dynamic_content_routing",
    exact_global_window_budget=24576,
    dynamic_per_tubelet_budget=True,
    roi_modifier_enabled=False,
    residual_modifier_enabled=False,
    full_training_split=True,
    official_validation_evaluation=True,
)
work_dir = f"{os.environ['ZOOMTOKEN_FULL_RUN_ROOT']}/Q"
