...
# H65 Unit1: the only new trainable mechanism is a zero-initialized shared
# relative physical-time residual in the first VideoMAE attention block.
...
work_dir = "exps/thumos/adatad/duca_h65_first_singleclock_cycle2"
