"""Two real-loader epochs for the no-robust-supervision arm."""
_base_ = ["./duca_evidence_recovery_no_robust.py"]
...
work_dir = "exps/thumos/adatad/duca_evidence_a3_optimizer_precheck"
