...
bafdr_protocol = dict(
    ...
    distillation=True,
    teacher_config=f"configs/adatad/thumos/bafdr_k16_d160_seed4407.py",
    teacher_checkpoint=f"exps/thumos/adatad/bafdr_k16_d160_seed4407/checkpoint/epoch_59.pth",
)
work_dir = f"exps/thumos/adatad/bafdr_k16_full_seed4407"
