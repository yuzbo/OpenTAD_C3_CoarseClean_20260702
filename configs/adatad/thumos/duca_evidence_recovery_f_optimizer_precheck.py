"""Two real-loader epochs for the full evidence-recovery arm."""
_base_ = ["./duca_evidence_recovery_full.py"]
...
work_dir = "exps/thumos/adatad/duca_evidence_f_optimizer_precheck"
