...
official_bc_arm = "Q64-GLOBAL"
model = dict(backbone=dict(custom=dict(georoute_official_support="q64_global")))
optimizer = dict(
    backbone=dict(
        custom=[
...
route_topology = dict(
    source_grid_hw=(10, 10), selected="stable_q_base_top64_global",
    tokens_per_tubelet=64, q_base_roi_modifier_enabled=False,
...
zoomtoken_p1_config = dict(
    schema_version="zoomtoken_r234_config_v001", arm_surface="Q64-GLOBAL", seed=42,
    source_commit=None, runner_binding_required=True, support="q64_global",
    support_topology="global_q_base_top64",
...
work_dir = "exps/thumos/adatad/georoute_official_q64_global_seed42_unbound"
