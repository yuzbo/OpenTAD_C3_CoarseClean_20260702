_base_ = ["./duca_cellcf_transition_beta0_fixed384_official_adatad_backend_full_train.py"]
...
workflow = dict(
    ...
    training_probe_json=os.environ.get(
        "DUCA_TRAINING_PROBE_JSON", "logs/duca_cellcf_transition_beta0_p0_ddp_pilot.json"
    ),
)
