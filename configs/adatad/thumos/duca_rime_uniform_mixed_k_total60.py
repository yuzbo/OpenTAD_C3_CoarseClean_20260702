...
duca_rime_variant = dict(
    ...
    training_schedule_seed=3407,
    training_schedule_source="stateless_epoch_plus_sample_index",
    exact_per_video_histogram=True,
...
duca_rime_contract = dict(
    ...
    candidate_budgets=candidate_budgets,
    target_mean_cost=float(evaluation_budget),
    training_target_mean_cost=target_mean_cost,
