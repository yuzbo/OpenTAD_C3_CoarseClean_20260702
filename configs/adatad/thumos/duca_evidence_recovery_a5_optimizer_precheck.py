"""Two real-loader epochs for the no-dense-recovery arm."""
_base_ = ["./duca_evidence_recovery_no_recovery.py"]
...
work_dir = "exps/thumos/adatad/duca_evidence_a5_optimizer_precheck"
