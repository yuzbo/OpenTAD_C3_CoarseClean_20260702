...
duca_online_main_contract = dict(
    stage="duca_online_x3d_official_adatad_backend_full_train",
    detector_stack="official_OpenTAD_AdaTAD_VideoMAE-S_ActionFormerHead_plus_DUCA_prebackbone_plugin_plus_X3D_JSONL_actionness",
...
work_dir = "exps/thumos/adatad/duca_online_x3d_official_adatad_backend_full_train"
