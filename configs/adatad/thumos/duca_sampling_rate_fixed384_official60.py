...
workflow = dict(
    ...
    val_loss_interval=-1,
    # Full official validation at epochs 5, 10, ..., 60 exposes the complete
    # learning curve. It never changes gradients or stops training, but the
    # best EMA checkpoint is retained alongside the terminal-EMA comparison.
    val_eval_interval=5,
