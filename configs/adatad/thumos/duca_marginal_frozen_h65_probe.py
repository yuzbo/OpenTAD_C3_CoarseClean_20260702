...
duca_marginal_probe = dict(
    ...
    scout_training_enabled=False,
    utility_head_fitting_enabled=True,
    budgets=[256, 384, 512],
    baseline_budget=384,
    ...
    allocation=dict(
        ...
        target_actual_observations="sum(min(valid_observations_i, 384)) within each video",
    ...
    execution=dict(
        ...
        group_windows_by_realized_packetized_execution_length=True,
        detector_length=384,
        padding_to_upper_budget=False,
        packet_size=16,
        historical_k384_execution_slots=384,
        historical_k384_padding_exception=True,
        collapsed_nonbaseline_tier_aliases_k384=True,
        collapsed_nonbaseline_second_forward=False,
    ),
    gates=dict(
