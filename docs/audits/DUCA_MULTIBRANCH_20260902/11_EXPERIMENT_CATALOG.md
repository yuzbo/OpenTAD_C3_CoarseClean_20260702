...
最后更新时间（UTC）：`2026-09-03T08:45:24+00:00`
...
| BAFDR 当前 seed 4407 正式流水线：D160 教师与五臂 K16 筛选（`BAFDR_ACTIVE`） | `E:/DeskTop/TAD/_duca_fix_worktrees/bafdr_admission` | [`539287fa`](https://github.com/yuzbo/OpenTAD_C3_CoarseClean_20260702/commit/539287fa8a035765afd7e79863ce77278bef83f2) | 真实 CUDA/focused 门禁 1267855 已通过；按分钟等待队列名额后启动 D160 教师，再依次提交 G96、U16、LATE、NOKD、FULL | 教师尚未成功训练，学生五臂尚未提交，无终态性能：保留 1267818 的 /bin/sh wrap 失败；539287fa 已改为 bash -lc 并重跑门禁；efe69d2e checkpoint 由独立任务按旧 SHA 另行评测，不能归入本提交 | 完成同 SHA、同 seed 的 D160 epoch-59 EMA 教师后开放五臂 screen |
...
| Evidence-Recovery 当前 C0：轻量侦察器不确定性与最大空洞补漏（`EVIDENCE_ACTIVE`） | `E:/DeskTop/TAD/OpenTAD_Evidence_FormalRepair_20260903` | [`0d1abf6d`](https://github.com/yuzbo/OpenTAD_C3_CoarseClean_20260702/commit/0d1abf6dc0b3b5f13c1f18118e0689af32d84229) | 修复后 admission 1267834 为 28 passed 且 CUDA 门禁通过；C0 seed 8261 训练 1267857 正在运行，评估 1267858 等待 | C0 正式训练进行中，尚无终态性能：保留 1267747 的 219-vs-100 loader 合同失败；0d1abf6d 改为每 epoch 确定性暴露 100 batch、共 6000 成功更新 | 先确认 C0 完成首个 100-update epoch，再逐步释放其余七个消融臂 |
...
| `1267747,1267748` | `/data/run01/sczc063/yuzibo/projects/duca_evidence_formal_21d1d229` | `21d1d229` | Evidence C0 首次正式启动因 DataLoader 219 batches 与 100-update 合同实现冲突而失败；0d1abf6d 已修复并用 1267857/1267858 新 namespace 重提 |
