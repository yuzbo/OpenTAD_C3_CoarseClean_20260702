...
schedule. Matched validations at epochs 41/43/45/47/49/51/53 consistently preserve the
physical-metric lead; the latest is selected-axis/physical-metric
`41.36/57.56%` Avg-mAP (`+16.19`), with physical-metric ahead at every IoU
