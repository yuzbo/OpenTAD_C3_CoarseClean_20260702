...
schedule. Matched validations at epochs 41/43/45/47/49/51/53/55 consistently preserve the
physical-metric lead; the latest is selected-axis/physical-metric
`41.44/57.66%` Avg-mAP (`+16.22`), with physical-metric ahead at every IoU
