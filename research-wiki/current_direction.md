...
The first same-epoch validation at epoch 41 is `39.84%` selected-axis versus
`57.32%` physical-metric Avg-mAP. This is interim evidence only; epoch 59 and
the completion/checkpoint contracts remain pending, so no full60 terminal or
