...
- `query_pack.md`: 4919 characters, below the 8000-character limit.
...
- The 2026-07-20 Native-Crop Pro review is archived and absorbed. It authorizes
  only a development-only, no-training vertical slice. No source-native crop
  implementation, sufficiency result, route-level GO/KILL, learned policy, or
  paper-ready claim exists.
