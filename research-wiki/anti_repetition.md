...
57. 2026-09-07 后续心跳已确认约 510 GiB 可用空间，且正式提交前再次检查至少
    160 GiB 余量。新 PRECHECK `1276607/1276608` 均 `COMPLETED 0:0`，分别17/11项测试通过。
    唯一当前正式作业为 D2S `1276621`（`d2s_tad_full200_compute_21aa2945_formal_r5`）和
    PA-TAD `1276622`（`patad_full200_compute_21aa2945_formal_r4`），17:50:33开始运行。
    运行版本仍为 clean `21aa2945`；没有模型代码变更。不得把旧失败作业继续报告为运行中，
    不得重用旧目录或重复提交当前新作业。保持每30分钟监督，完整终态前不消费部分准确率。
