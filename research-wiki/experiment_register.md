...
| `exp:phystime-g1-matched-full60` | selected-axis vs physical-metric, K384/J192 | gate passed; jobs `1170946/1170947` running | latest matched epoch-49 Avg-mAP `41.16/57.54`; epoch 59 pending | Validate the physical-metric medium survivor under an exact 60-epoch schedule |
