...
verdict: interim_epochs41_to51_support_physical_metric_pending_epoch59
confidence: six_matched_interim_validations_not_full60_complete
metrics: "Latest epoch 51 interim: selected-axis 41.24, physical-metric 57.44 Avg-mAP; matched epochs 41/43/45/47/49/51 preserve the ordering; final epoch 59 and FULL_COMPLETE validation pending."
...
Matched validations after epochs 43, 45, 47, 49, and 51 retained the same ordering.
The latest epoch-51 values are selected-axis `41.24%`, physical-metric
`57.44%`, delta `+16.19` Avg-mAP. Across epochs 41/43/45/47/49/51, the interim
...
The current status is `experiment_running`. Interim epoch-41-to-51 mAP exists, but
