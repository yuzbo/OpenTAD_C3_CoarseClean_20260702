...
verdict: interim_epochs41_to49_support_physical_metric_pending_epoch59
confidence: five_matched_interim_validations_not_full60_complete
metrics: "Latest epoch 49 interim: selected-axis 41.16, physical-metric 57.54 Avg-mAP; matched epochs 41/43/45/47/49 preserve the ordering; final epoch 59 and FULL_COMPLETE validation pending."
...
Matched validations after epochs 43, 45, 47, and 49 retained the same ordering.
The latest epoch-49 values are selected-axis `41.16%`, physical-metric
`57.54%`, delta `+16.37` Avg-mAP. Across epochs 41/43/45/47/49, the interim
physical-metric advantage is consistently `+16.37` to `+17.48` Avg-mAP.
...
The current status is `experiment_running`. Interim epoch-41-to-49 mAP exists, but
