...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 05:04核查：训练1280117仍COMPLETED(0:0)，12次完整测试和best收据有效，终态及best stat未变；远端训练源exact/clean。edfbd7e5独立评测已通过34项本地/远端测试及双GPU PRECHECK1281042_1；新job1281049_1于05:13:04 RUNNING，05:21两项分别推理至OFF226/396、ON184/396，尚无独立metrics。没有重新训练",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 05:04核查：训练1280118仍COMPLETED(0:0)，12次完整测试和best收据有效，终态及best stat未变；远端训练源exact/clean。edfbd7e5独立评测已通过34项本地/远端测试及双GPU PRECHECK1281042_0；新job1281049_0于05:13:04 RUNNING，05:21两项分别推理至OFF226/396、ON184/396，尚无独立metrics。没有重新训练",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 05:04核查：训练1280127仍COMPLETED(0:0)，12次完整测试和best收据有效，终态及best stat未变；远端训练源exact/clean。复用36号实际终态EMA、全局6000与参数参与次数分布；独立终态评测及少步参数归属仍待补",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 05:04核查：训练1280128仍COMPLETED(0:0)，12次完整测试和best收据有效，终态及best stat未变；远端训练源exact/clean。复用36号实际终态EMA、全局6000与参数参与次数分布；独立终态评测及少步参数归属仍待补",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 05:04核查：训练1280129仍COMPLETED(0:0)，12次完整测试和best收据有效，终态及best stat未变；远端训练源exact/clean。复用36号实际终态EMA、全局6000与参数参与次数分布；独立终态评测及少步参数归属仍待补",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {"checked_at_cst": "2026-09-09 05:14 CST", "public_gpu_available": 52, "public_gpu_total": 200, "gpu_count_basis": "scontrol CfgTRES/AllocTRES，排除DOWN/DRAIN/FAIL/UNKNOWN/FUTURE/POWERED_DOWN；公共余量不保证个人即时配额", "user_jobs_in_queue": 4, "account_constraint": "3 RUNNING/1 PENDING；其中本任务新增2项ET独立终态评测，各2GPU。其他运行及held任务未操作。五项新训练早已完成，不是等待GPU；实验盘121.33GiB可用"},
        ...
        "heartbeat_evidence": "38_HEARTBEAT_EVIDENCE_20260909_0456.json",
        "performance_cause_audit_scope": "2026-09-09 05:04实时核对五项完整训练、60次周期与5份best，指标均未变且收据有效；H65四相/ET低秩开启负结果仍在，CT最高64.2720%。本轮edfbd7e5补正确新SHA的ET独立终态绑定，34项本地/远端测试与1281042双GPU预检通过，1281049_0/1于05:13正式评测运行。尚无新独立终态指标；无训练模型修改、调参或重复训练；历史90轮失败继续保留",
