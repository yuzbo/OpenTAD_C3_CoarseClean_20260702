...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "name": "H65-Pro 当前已完成六臂：旧分配策略下的归因、课程与骨干消融（四相未开启）",
            ...
            "current_cycle": "2026-09-08 09:33:57 CST：六份F臂小收据可读，mtime与数值未变，最高仍64.2265%；复用06:39自哈希及终态身份验证，不重复大权重加载或推理。无新TIA修复或四相开启结果。共享官方原配方1245842的68.73%仍是此前核查的原始日志值，预训练/数据身份及独立复评待补证；修改REF67.58%/63.89%不能替代官方锚点",
            ...
            "latest_repair": {"branch": "codex/h65-pro-generator-repair-20260908", "sha": "aac9df0fd896edf9bf440a123e0424bb641df012", "local_directory": "E:/DeskTop/TAD/_duca_fix_worktrees/h65_admission", "remote_source": "/data/run01/sczc063/yuzibo/projects/h65_generator_aac9df0f", "validation": "本地33 passed/10 Windows Torch skipped；远端exact-SHA clean CPU43 passed。生成base与提交base AST等价；未改变现有模型或重训", "status": "GENERATOR_FIXED; TIA_AND_MATCHED_CONTROL_PENDING"},
            ...
            "next_action": "复用已找到的1245842原始产物，补预训练/数据身份及官方同权重行为对齐；不默认重训共享原版。按真实每视频布局修复TIA并测试跨clip但不跨视频的输出/梯度，不能给稀疏分支盲填384常量。随后在同SHA/optimizer/配方下设置U384与必要phase-on/off对照，不按测试分数选参",
        },
        {
            "category": "correction_route",
            ...
            "current_cycle": "2026-09-08 09:33-09:35 CST：fe1c53db G0/G1仍RUNNING，落盘audit分别epoch44/46、optimizer/scheduler/EMA各4500/4700，AMP skip均3且已重放。G0 epoch45 batch99结束后在评测，G1已到epoch47 batch50，最新loss0.4519/0.4641有限；未见epoch59或新fatal。07383274独立evaluator的1278042已COMPLETED(0:0)，31 GPU tests及四臂单批推理全部通过。旧G2/G3沿用原身份56.5234%/57.8489%，无新正式mAP；本轮只收取既有预检终态，不重复训练或预检",
            ...
            "latest_repair": {"branch":"codex/duca-ctdp-coordinate-repair-20260908","sha":"fe1c53db1b2a7e467a6af2eccfe8b7636f667a81","local_directory":"E:/DeskTop/TAD/_duca_fix_worktrees/ctdp_successful_updates","remote_source":"/data/run01/sczc063/yuzibo/projects/ctdp_coordinate_fe1c53db","validation":"本地32 passed/1 CUDA skipped；最终SHA远端clean CPU52 passed/1 CUDA skipped。1278007的71 tests、CT_CUDA_GATE_OK及四臂真实PRECHECK此前已通过，各6次更新。09:35新正式G0/G1落盘audit分别4500/4700，无epoch59；本轮不重复已通过的训练准入","status":"CUDA_AND_REAL_PRECHECK_PASS; G0_G1_FORMAL_RUNNING","admission_job":"1278007","admission_state":"COMPLETED(0:0), ended 2026-09-08 02:51:01 CST","admission_stdout":"/data/run01/sczc063/yuzibo/slurm_logs/ctdp-coordinate-fe1c53db_1278007.out","admission_stderr":"/data/run01/sczc063/yuzibo/slurm_logs/ctdp-coordinate-fe1c53db_1278007.err","precheck_run_root":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_fe1c53db/precheck","formal_jobs":{"G0":"1278011","G1":"1278012"},"formal_job_states":{"G0":"RUNNING; epoch45 batch99 complete, evaluation in progress; persisted epoch44 optimizer/scheduler/EMA4500; checked 2026-09-08 09:35 CST","G1":"RUNNING; epoch47 batch50; persisted epoch46 optimizer/scheduler/EMA4700; checked 2026-09-08 09:35 CST"},"formal_run_root":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_fe1c53db/formal","formal_stdout":{"G0":"/data/run01/sczc063/yuzibo/slurm_logs/ctdp-g0-fe1c53db_1278011.out","G1":"/data/run01/sczc063/yuzibo/slurm_logs/ctdp-g1-fe1c53db_1278012.out"},"formal_stderr":{"G0":"/data/run01/sczc063/yuzibo/slurm_logs/ctdp-g0-fe1c53db_1278011.err","G1":"/data/run01/sczc063/yuzibo/slurm_logs/ctdp-g1-fe1c53db_1278012.err"},"launch_contract":"PRECHECK_ONLY=0; CTDP_STAGE=geometry; seed3407; one GPU per arm; exact new SHA; fresh output; 60 epochs/6000 successful updates; no resume from PRECHECK","first_log_observation":"08:01累计AMP skip均3，无replay耗尽或Traceback；epoch41最终batch loss G0=0.4476/G1=0.4852有限。stderr评测分别到161/374批，仍有既有linear1d非确定性警告，不能声称消除全部随机性","formal_update_observation":{"checked_at_cst":"2026-09-08 09:35:43 CST","G0":{"epoch":44,"successful_optimizer_updates":4500,"scheduler_updates":4500,"ema_updates":4500,"optimizer_attempts":4503,"amp_skipped_attempts":3},"G1":{"epoch":46,"successful_optimizer_updates":4700,"scheduler_updates":4700,"ema_updates":4700,"optimizer_attempts":4703,"amp_skipped_attempts":3}}},
            "coordinate_evaluator": {"branch":"codex/duca-ctdp-coordinate-terminal-eval-20260908","sha":"073832744dd171dee4119dc29d1bb12a057e84f4","training_sha":"fe1c53db1b2a7e467a6af2eccfe8b7636f667a81","github_commit":"https://github.com/yuzbo/OpenTAD_C3_CoarseClean_20260702/commit/073832744dd171dee4119dc29d1bb12a057e84f4","local_directory":"E:/DeskTop/TAD/_duca_fix_worktrees/ctdp_coordinate_eval","remote_source":"/data/run01/sczc063/yuzibo/projects/ctdp_coordinate_eval_07383274","local_validation":"45 passed, 1 CUDA skipped; coordinate collection blocked by Windows Torch c10.dll; py_compile and bash -n PASS","remote_validation":"07383274 exact-SHA clean Linux 50 passed/1 CUDA skipped, including real coordinate regression; py_compile PASS; opentad/configs diff from fe1c53db empty; completed 2026-09-08 08:09 CST","status":"GPU_PRECHECK_PASS; FORMAL_WAITING_TERMINAL_TRAINING","precheck_train_root":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_fe1c53db/precheck","precheck_eval_root":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_eval_07383274/precheck","formal_train_root":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_fe1c53db/formal","formal_eval_root":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_eval_07383274/formal","scope":"No model/config changes from fe1c53db; rejects old78 checkpoints; inference PRECHECK consumes existing1278007 checkpoints, not repeat training admission; formal evaluation awaits terminal epoch59/6000","precheck_job":"1278042","precheck_state":"COMPLETED(0:0), started 2026-09-08 08:11:29, ended 08:14:51 CST; sacct and all four arm markers observed 09:33 CST","precheck_stdout":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_eval_07383274/slurm_logs/precheck_1278042.out","precheck_stderr":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_eval_07383274/slurm_logs/precheck_1278042.err","precheck_launch":{"script":"scripts/run_ctdp_terminal_eval_n16r4.sbatch","PRECHECK_ONLY":"1","CTDP_EVAL_REPO":"/data/run01/sczc063/yuzibo/projects/ctdp_coordinate_eval_07383274","CTDP_EVAL_COMMIT":"073832744dd171dee4119dc29d1bb12a057e84f4","CTDP_TRAIN_ROOT":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_fe1c53db/precheck","CTDP_EVAL_ROOT":"/data/run01/sczc063/yuzibo/experiments/ctdp_coordinate_eval_07383274/precheck","gres":"gpu:1"},"formal_evaluation_jobs":[],"setup_issue":"Initial synchronous SSH command timed out after checkout completed; no CPU PASS assumed. Reused completed clean checkout; separate bounded validation finished successfully, FastCtx job j-1ywacm.","precheck_observed_validation":"31 GPU tests passed; G0/G1/G2/G3 each epoch1 state_dict_ema, actual optimizer/scheduler/EMA6 and 337 optimizer states verified, followed by one-batch inference PASS; CTDP_ALL_EVAL_PRECHECKS_OK. Existing job only, not rerun this cycle.","precheck_verified_arms":["G0","G1","G2","G3"],"terminal_query_issue":"Historical 08:16-08:22 SSH queries timed out; recovered read-only access at 2026-09-08 09:32:19 CST. Existing1278042 completed normally; no Slurm resubmission or cancellation.","remote_identity_recheck":"2026-09-08 09:33-09:35 CST: fe1c53db training and07383274 evaluator HEAD exact/clean; git diff fe1c53db HEAD -- opentad configs empty. Initial inspection used nonexistent combined opentad/configs path; corrected read-only git query returned0 with no changes."},
            ...
            "next_action": "监督新G0/G1，不重复1278007训练准入、1278042推理预检或正式训练；07383274已通过exact-SHA Linux与四臂GPU单批PRECHECK。等待epoch59 EMA及6000真实计数后，仅用07383274新目录按臂提交独立正式评测。旧G0/G1仅作诊断，G2/G3沿用原身份，不盲目重跑全矩阵",
        },
        {
            "category": "correction_route",
            ...
            "current_cycle": "2026-09-08 09:33:57 CST：本地HEAD793c4f9c且clean；生成目录时再记录local_head/local_clean_tree。Taylor P0/P1运行时接线、合法one-swap及H65 retention/transition仍未修复，无新部署，继续BLOCKED_UNIMPLEMENTED。这是实现欠账，不是资源排队；本轮未重做全源码审查",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 09:33-09:37 CST：U16/LATE/NOKD及FULL PRECHECK1277955均COMPLETED(0:0)。前三臂stdout保存epoch59 at update6000，err无新fatal；实际权重验证复用04:28记录，不重复加载。710ce8a6输出根仍没有metrics.json，FULL只有PRECHECK。padding/screen缺陷未修复，不开放FULL正式训练或21单元；历史1267920/1267921仅查询状态，未操作",
        ...
        },
        {
            ...
            "scientific_audit": "固定stride anchors加共享rank64可学习残差代理，不是精确anchor-dependent Jacobian或已落地事件门控。邻接temporal-conv tap可使anchor correction非零，须在TIA之前保持精确anchor残差；TIA本身可合法跨时混合。OFF/ON训练AMP与独立评测精度仍需按实际CLI/log核对，不能只凭配置或收据宣称已对齐。当前-7.2672pp不证明一般Taylor思想失败或70%计算节省",
            ...
            "current_cycle": "2026-09-08 09:33:57 CST：OFF/ON两份小收据可读，mtime与数值未变，仍62.0768%/54.8096%。复用06:39自哈希及原训练74473c27/评测67d7079d终态认证，不重复大权重加载或推理。anchor correction及实际精度核对尚未完成，旧负结果不改写",
            ...
            "next_action": "修复TIA之前anchor correction泄漏，并用非中心卷积tap、跨段及梯度回归验证；从真实训练CLI/log确认AMP与评测精度，必要时仅重跑同权重匹配精度评测。保留旧负结果；将固定anchor低秩代理与事件触发/精确JVP主张分开，再设计dense/零阶/当前代理的匹配消融",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 09:33-09:35 CST：A1/A6/F训练1277406_2/1277407_7/1277768_1及A1评测1277953_2均COMPLETED(0:0)。补核实际slurm_logs路径，末段Training/Testing Over，未见新fatal；配置行fail_on_amp_replay_exhaustion=True不是运行失败。A1小收据mtime未变，metrics.average_mAP仍0.5159681679375281；A6/F仍缺独立metrics。复用04:30终态及跨SHA恢复验证，utility/robust/cycle缺失仍阻止A3/A4/A5扩展",
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {
            "checked_at_cst": "2026-09-08 09:33 CST",
            "public_gpu_available": 61,
            "public_gpu_total": 200,
            "gpu_count_basis": "09:33 scontrol show nodes的gpu分区，排除DOWN/DRAIN/FAIL/MAINT/RESERVED/NOT_RESPONDING后25节点CfgTRES200、AllocTRES139；公共未分配61，不等于本账户额度",
            "user_jobs_in_queue": 6,
            "account_constraint": "09:33展开数组为6 RUNNING/0 PENDING，其中本任务CT G0/G1占2项；无当前排队原因可据以判断账户可提交额度。实验挂载245G可用、96%已用，公共空间不保证个人配额。未提交、取消或重提作业，历史BAFDR1267920/1267921只读不动",
        },
        ...
        "heartbeat_evidence": "19_HEARTBEAT_EVIDENCE_20260908_0931.json",
        "performance_cause_audit_scope": "本轮2026-09-08 09:31:29触发，实际远端采样09:32-09:37：六路线本地身份、Slurm、CT audit/stdout/stderr、H65/ET/Evidence小收据、BAFDR终轮日志及资源。SSH读取恢复，收取既有1278042四臂推理PRECHECK终态；没有新正式mAP、代码修复或Slurm提交，不重复大checkpoint/已认证哈希。未执行的其他触发不补记为已检查",
...
def md_text(payload: dict[str, Any]) -> str:
    ...
    lines += [
        ...
        "## 监督器与动态状态",
        "",
        f"远端 N16R4 监督器恢复目录：`{REMOTE_ROOT}`，每60秒轮询；本地heartbeat每30分钟刷新本表并用中文详细通知用户，即使无变化。当前回执状态：`{payload['remote_supervisor'].get('status')}`，距生成`{payload['remote_supervisor'].get('receipt_age_seconds', '未知')}`秒；dispatcher：`{payload['remote_supervisor'].get('dispatcher_status', '未知')}`，mode：`{payload['remote_supervisor'].get('dispatcher_mode', '未知')}`。旧进程因磁盘配额退出的日志保留；新进程恢复只读轮询，超过180秒标STALE。dispatcher不自动续提当前修复队列。本轮收取兼容评测器07383274既有预检终态，确认G0/G1继续训练；没有新增作业、重复准入或取消旧任务。",
        "",
