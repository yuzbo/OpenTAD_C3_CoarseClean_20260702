...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "result_status": "正式训练进行中：REF-D768/REF-U384 已进入 epoch 54，REF-MNV3FC384 已进入 epoch 52；尚无终态性能",
        ...
        },
        {
            ...
            "result_status": "四臂正式训练进行中：G0 已完成 epoch 43，G1 已进入 epoch 44，G2/G3 已完成 epoch 45；部分作业正在周期推理，尚无终态性能",
        ...
        },
        {
            ...
            "deployment_status": "真实 CUDA/focused 门禁 1267855 已通过；D160 seed 4407 教师 1267884 已完成，G96 正式训练 1268698 正在运行并已保存 epoch 29/update 3000；U16、LATE、NOKD、FULL 等待流水线释放",
        ...
        },
        {
            ...
            "result_status": "双臂均已完成 epoch 37 并正在周期推理；最新中期验证 OFF Avg-mAP 63.21%、ON 55.42%，仍不是终态性能",
            "final_result": "最新中期验证 OFF/ON 的 tIoU 0.3/0.4/0.5/0.6/0.7 分别为 78.41/74.04/65.76/55.70/42.12% 与 71.81/66.15/58.04/47.33/33.75%；当前 loss 有限，需等待 epoch-59 EMA 才能裁决",
        ...
        },
        {
            ...
            "result_status": "C0 已完成 epoch 0-40 并进入 epoch 41，累计 4100 次成功更新，尚无终态性能",
            "final_result": "最新审计显示 available 219/exposed 100、successful/EMA/scheduler updates 均为 4100、selector schedule 为 0、nonfinite=0；尚无 epoch-59 EMA 或 official mAP",
