...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "excluded_remote_jobs": [
            ...
            {"job_ids": "1266401-1266420", "remote_directory": "/data/run01/sczc063/yuzibo/projects/bafdr_k16_fullmatrix_5dba75c7", "source_head": "efe69d2ea10accd01d0129dfe99cba4d1d5773cb", "reason": "非当前冻结 BAFDR checkout；1266401/1266402 因 LoadFrames 不支持窗口参数失败，其他作业仍在运行或依赖等待，全部不纳入当前结果"},
