...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "result_status": "正式训练进行中：REF-D768/REF-U384 已进入 epoch 16，REF-MNV3FC384 已进入 epoch 15；尚无终态性能",
        ...
        },
        {
            ...
            "result_status": "四臂正式训练进行中：G0 epoch 20、G1 epoch 21、G2/G3 epoch 22；尚无终态性能",
        ...
        },
        {
            ...
            "deployment_status": "真实 CUDA/focused 门禁 1267855 已通过；D160 seed 4407 教师 1267884 正在运行，已保存 epoch 19/update 2000 checkpoint；成功后按分钟提交 G96、U16、LATE、NOKD、FULL",
        ...
        },
        {
            ...
            "result_status": "双臂正式训练均已完成 epoch 15，尚无终态性能",
        ...
        },
        {
            ...
            "result_status": "C0 已完成 epoch 0-6，累计 700 次成功更新，尚无终态性能",
            "final_result": "最新审计显示 available 219/exposed 100、successful/EMA/scheduler updates 均为 700、selector schedule 为 0、nonfinite=0；尚无 epoch-59 EMA 或 official mAP",
