...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "result_status": "正式训练进行中：REF-D768/REF-U384 已进入 epoch 42，REF-MNV3FC384 已进入 epoch 39；尚无终态性能",
        ...
        },
        {
            ...
            "result_status": "四臂正式训练进行中：G0 已进入 epoch 40，G1/G2/G3 已进入 epoch 41；尚无终态性能",
        ...
        },
        {
            ...
            "deployment_status": "真实 CUDA/focused 门禁 1267855 已通过；D160 seed 4407 教师 1267884 已完成，G96 正式训练 1268698 正在运行并已保存 epoch 4/update 500；U16、LATE、NOKD、FULL 等待流水线释放",
        ...
        },
        {
            ...
            "result_status": "双臂正式训练进行中：OFF 已进入 epoch 31，ON 已进入 epoch 30；最新中期验证 OFF Avg-mAP 62.15%、ON 54.01%，仍不是终态性能",
            "final_result": "最新中期验证 OFF/ON 的 tIoU 0.3/0.4/0.5/0.6/0.7 分别为 78.40/73.46/64.38/54.12/40.41% 与 70.89/64.85/56.37/45.61/32.33%；当前 loss 有限，需等待 epoch-59 EMA 才能裁决",
        ...
        },
        {
            ...
            "result_status": "C0 已完成 epoch 0-29 并进入 epoch 30，累计 3000 次成功更新，尚无终态性能",
            "final_result": "最新审计显示 available 219/exposed 100、successful/EMA/scheduler updates 均为 3000、selector schedule 为 0、nonfinite=0；尚无 epoch-59 EMA 或 official mAP",
