...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 23:52状态、23:57成绩：629162cd三组RUNNING，第40轮全测试均匀/相位关/四相开63.4838%/63.2568%/57.0365%，均为当前最佳。审计4000/4000/4200成功更新一致，AMP skip累计3/9/7，耗尽0。历史30+60匹配另列：signed/control已到epoch12，fulltia尚未见实际启动",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 23:45只读核查：G0/G1独立成绩64.2720%/61.6740%及已有终态未变；复用真实6000更新与收据认证，不重复加载或评测。G2/G3保留旧身份，后续机制矩阵eval5仍待接入",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 23:45-23:48：旧793c4f9c及后继0fcef0bf时间轴修复没有新增正式结果；后继本地clean且GitHub仍未见该分支。真实Taylor P0/P1、合法one-swap、H65 retention/transition仍未完成，不能把时间轴接线修复当整套实现",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 23:45只读核查：710ce8a6五份6000更新终态保留，新独立metrics仍0，FULL1277955仅PRECHECK。后继padding修复b142bffa本地clean/GitHub未见分支；真实terminal screen、eval5及生产验证仍待完成。历史1267920/1267921未操作",
        ...
        },
        {
            ...
            "scientific_audit": "仍为fixed-stride anchors加共享rank64可学习代理，不是精确anchor-dependent Jacobian或真实event gate。9a346f0d已修复TIA前anchor correction污染，实际2GPU/global batch2/FP32。ON完成12次全测试，最佳55.3617%、第60轮训练内54.5976%；OFF终态未完成，新独立terminal receipt尚缺。不能说已完整事件触发、无损或70%计算节省，也不把性能差值分摊给某单一原因",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 23:45只读核查：旧A1/A6/F训练均COMPLETED(0:0)，A1独立成绩51.5968%未变，F/A6仍缺独立receipt。后继79aea08a接线修复本地clean/GitHub未见分支；utility/真实two-view/cycle/eval5和生产验证仍未完成，旧分数不迁移给新SHA",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 23:52状态、23:57补收成绩：1280117 COMPLETED(0:0)，23:23:38结束、耗时6:02:07；全测试已返回第60轮，最佳为第40轮。最佳未变，复用21:31实际EMA认证，不重复加载；远端exact/clean，未发现新增fatal",
            "result_status": "训练与12次全测试已完成；最佳及终轮训练内成绩可报告，独立终态receipt尚缺",
            "final_result": "完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 5.7073%；第10轮 32.0496%；第15轮 42.1020%；第20轮 47.3332%；第25轮 51.8133%；第30轮 54.2127%；第35轮 55.3159%；第40轮 55.3617%；第45轮 55.2871%；第50轮 55.0948%；第55轮 54.8392%；第60轮 54.5976%；最佳第40轮 55.3617%，对应mAP@0.7为33.6320%。最佳未变，复用21:31实际EMA认证，不重复加载。全部周期及best收据自哈希通过；测试集参与选模，不称独立未见测试泛化。第60轮训练内EMA官方评测54.5976%，独立保留epoch59权重；真实373个optimizer state均6000、scheduler6000、571项EMA有限。EMA调用次数依据FP32成功更新控制流推导，checkpoint未保存独立EMA计数。尚未取得新SHA独立terminal evaluator receipt，不冒称独立封存完成",
            "periodic_results": [{"completed_epochs": 5, "successful_updates": 500, "metrics": {"average_mAP": 0.05707277898916985, "mAP@0.3": 0.14853791363930052, "mAP@0.4": 0.08500319659711006, "mAP@0.5": 0.03580691651796845, "mAP@0.6": 0.012255466313933306, "mAP@0.7": 0.0037604018775368787}, "receipt_sha256": "4e88641c187eb29f75140c59dade549c3a0a3fd57945c865ef81d21363dd8a26"}, {"completed_epochs": 10, "successful_updates": 1000, "metrics": {"average_mAP": 0.320496021124476, "mAP@0.3": 0.5166897764065521, "mAP@0.4": 0.4334037863526487, "mAP@0.5": 0.3301485076758973, "mAP@0.6": 0.21667574033234255, "mAP@0.7": 0.10556229485493962}, "receipt_sha256": "c8c9ae21ecd2b13af91c583a542db4a5ab5b945007057faddacbfd826b19c301"}, {"completed_epochs": 15, "successful_updates": 1500, "metrics": {"average_mAP": 0.4210201639208712, "mAP@0.3": 0.6125611184992682, "mAP@0.4": 0.535889186101856, "mAP@0.5": 0.4446390956665815, "mAP@0.6": 0.3297551386979968, "mAP@0.7": 0.1822562806386534}, "receipt_sha256": "35f7f550790d9e46164f0693c8861141c6825594cc92661a5d8f48cb10fe78f6"}, {"completed_epochs": 20, "successful_updates": 2000, "metrics": {"average_mAP": 0.4733319113379942, "mAP@0.3": 0.6628811406586299, "mAP@0.4": 0.5901549710067809, "mAP@0.5": 0.5006061764916419, "mAP@0.6": 0.3805665396581247, "mAP@0.7": 0.23245072887479332}, "receipt_sha256": "1e820bb5a9a1753486cacb03bf4b551b58d9274d4662b0416b35d37e677c870d"}, {"completed_epochs": 25, "successful_updates": 2500, "metrics": {"average_mAP": 0.5181327185058566, "mAP@0.3": 0.6996220127694024, "mAP@0.4": 0.6367092318294373, "mAP@0.5": 0.5444685838524658, "mAP@0.6": 0.4223845323304126, "mAP@0.7": 0.28747923174756485}, "receipt_sha256": "1b2523042e0c576983ca36257a6224624cef7fcc628b2741da30f29006b278af"}, {"completed_epochs": 30, "successful_updates": 3000, "metrics": {"average_mAP": 0.5421274495036355, "mAP@0.3": 0.7156602863798243, "mAP@0.4": 0.6574225402196712, "mAP@0.5": 0.569649017121516, "mAP@0.6": 0.4517435684091953, "mAP@0.7": 0.3161618353879706}, "receipt_sha256": "7285cb88554f054dc5ea81869f5d7881b39346d02311f158cdc1ab7d9b2ff690"}, {"completed_epochs": 35, "successful_updates": 3500, "metrics": {"average_mAP": 0.5531589704845333, "mAP@0.3": 0.7195028397690317, "mAP@0.4": 0.6616926573342119, "mAP@0.5": 0.5827475276067282, "mAP@0.6": 0.4681615497312766, "mAP@0.7": 0.333690277981418}, "receipt_sha256": "437ac997c92ec239523fdfb09d5a815ff3b56f68cd112feb93aaefcbd071d409"}, {"completed_epochs": 40, "successful_updates": 4000, "metrics": {"average_mAP": 0.5536169738568958, "mAP@0.3": 0.7159378799858159, "mAP@0.4": 0.6591746139896045, "mAP@0.5": 0.5839129599109326, "mAP@0.6": 0.4727397320911512, "mAP@0.7": 0.33631968330697526}, "receipt_sha256": "2f5191ba284a9f108d69d68d2ced63ad57ddf87f3c0a3b7cc83040de91807c52"}, {"completed_epochs": 45, "successful_updates": 4500, "metrics": {"average_mAP": 0.5528706726103314, "mAP@0.3": 0.7135318651920318, "mAP@0.4": 0.657458888464367, "mAP@0.5": 0.5819949982460996, "mAP@0.6": 0.47201374679080266, "mAP@0.7": 0.3393538643583559}, "receipt_sha256": "107c92e7e8f045113ac70e63d71fb3d91e185a67a53e21054739b7a55635f0fa"}, {"completed_epochs": 50, "successful_updates": 5000, "metrics": {"average_mAP": 0.5509480734939481, "mAP@0.3": 0.7088150120512543, "mAP@0.4": 0.6578623562804997, "mAP@0.5": 0.5797274819138379, "mAP@0.6": 0.46954655877917617, "mAP@0.7": 0.33878895844497287}, "receipt_sha256": "78a7ba27c0106b6a04f5d4cbe969c580a2e3b2a952fb0a2463aea9c0025cf422"}, {"completed_epochs": 55, "successful_updates": 5500, "metrics": {"average_mAP": 0.5483918254480968, "mAP@0.3": 0.7043073740580456, "mAP@0.4": 0.6572542799483998, "mAP@0.5": 0.5745519470203349, "mAP@0.6": 0.4689576730955764, "mAP@0.7": 0.33688785311812763}, "receipt_sha256": "1c107ebf445f040ad9aa908aa6a9036de775c02507e85706183e02c7e42b029e"}, {"completed_epochs": 60, "successful_updates": 6000, "metrics": {"average_mAP": 0.5459757523556376, "mAP@0.3": 0.7014817893427924, "mAP@0.4": 0.6551665037610698, "mAP@0.5": 0.5723676303167357, "mAP@0.6": 0.4664689311820583, "mAP@0.7": 0.3343939071755316}, "receipt_sha256": "d48e366bd6cb60780ef6c4120d7ebb52745167c591c5f822ee72da6663793fa5"}],
            ...
            "next_action": "不重复训练或已通过准入。补与9a346f0d模型配置匹配的独立终态评测/权重绑定；等待OFF完整结果后作配对裁决，再记录测试指导的参数调整。保留第40轮最佳与第60轮权重、全部负结果；Pro仅按指定ixBrowser Computer Use入口，当前初始化阻塞未解决",
        },
        {
            "category": "test_guided_exploratory",
            ...
            "deployment_status": "2026-09-08 23:52状态、23:57补收成绩：1280118 RUNNING；全测试已返回第50轮，最佳为第35轮。最佳未变，复用21:31实际EMA认证，不重复加载；远端exact/clean，未发现新增fatal",
            "result_status": "中期测试选模结果（最新评测5000/6000 updates，最佳第35轮）；尚无终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 4.2952%；第10轮 33.7828%；第15轮 42.7081%；第20轮 53.8420%；第25轮 59.5824%；第30轮 62.0582%；第35轮 62.5093%；第40轮 62.4262%；第45轮 62.4605%；第50轮 62.3928%；最佳第35轮 62.5093%，对应mAP@0.7为41.1250%。最佳未变，复用21:31实际EMA认证，不重复加载。全部周期及best收据自哈希通过；测试集参与选模，不称独立未见测试泛化",
            "periodic_results": [{"completed_epochs": 5, "successful_updates": 500, "metrics": {"average_mAP": 0.04295212049884119, "mAP@0.3": 0.11231359964095504, "mAP@0.4": 0.06323970506636518, "mAP@0.5": 0.026467493009795222, "mAP@0.6": 0.009421238730616236, "mAP@0.7": 0.0033185660464742452}, "receipt_sha256": "2f47ae495364a78c0a2a5160b32e8cb7df75f32accb9c0ef7beaaf53837f0eee"}, {"completed_epochs": 10, "successful_updates": 1000, "metrics": {"average_mAP": 0.33782786747424576, "mAP@0.3": 0.5309770686836096, "mAP@0.4": 0.4461896590140941, "mAP@0.5": 0.3584564154180127, "mAP@0.6": 0.2306159555735646, "mAP@0.7": 0.12290023868194773}, "receipt_sha256": "bd391ac823db6941249a4b5469765326d7705e6819f5ca473f47390b9a71b27c"}, {"completed_epochs": 15, "successful_updates": 1500, "metrics": {"average_mAP": 0.42708126331904783, "mAP@0.3": 0.6486510709962328, "mAP@0.4": 0.5522955002787366, "mAP@0.5": 0.44226882369666276, "mAP@0.6": 0.31638814679343724, "mAP@0.7": 0.17580277483016976}, "receipt_sha256": "811710018b46e64e9fe4d775a45a69946fea192c71453e728ae916a74988d14f"}, {"completed_epochs": 20, "successful_updates": 2000, "metrics": {"average_mAP": 0.5384195465438297, "mAP@0.3": 0.7285218757412328, "mAP@0.4": 0.6571920285292107, "mAP@0.5": 0.5646392833829011, "mAP@0.6": 0.4386798748611989, "mAP@0.7": 0.3030646702046048}, "receipt_sha256": "59ec2afbd40b4b3e16d2e1a507bb6b6206978839af042ee891579b12b29df29a"}, {"completed_epochs": 25, "successful_updates": 2500, "metrics": {"average_mAP": 0.5958244606066547, "mAP@0.3": 0.7655100689066893, "mAP@0.4": 0.7131315384115839, "mAP@0.5": 0.6240487895701179, "mAP@0.6": 0.5084608078151849, "mAP@0.7": 0.36797109832969804}, "receipt_sha256": "a6ee65ae3aece409fe897b13e0e10d1d03585c61681b029ae041db6c9404aebe"}, {"completed_epochs": 30, "successful_updates": 3000, "metrics": {"average_mAP": 0.6205816747981233, "mAP@0.3": 0.7806666669489728, "mAP@0.4": 0.7301716964330796, "mAP@0.5": 0.6449194070825521, "mAP@0.6": 0.5455039360540052, "mAP@0.7": 0.4016466674720068}, "receipt_sha256": "de22e54ac6572efa19f66c6af590030719371bd3de244a5797f405ce738a5c01"}, {"completed_epochs": 35, "successful_updates": 3500, "metrics": {"average_mAP": 0.6250928583468067, "mAP@0.3": 0.7794447492356198, "mAP@0.4": 0.7323571662461678, "mAP@0.5": 0.6488339613958451, "mAP@0.6": 0.5535783927281407, "mAP@0.7": 0.41125002212826056}, "receipt_sha256": "5ca976a7060c072ff84ea0f0a77f03c87f4ab2bf42ccca534765d1e99ef0c019"}, {"completed_epochs": 40, "successful_updates": 4000, "metrics": {"average_mAP": 0.6242619817593542, "mAP@0.3": 0.7744946548682933, "mAP@0.4": 0.7272559958767965, "mAP@0.5": 0.6477180365457057, "mAP@0.6": 0.5519399843492903, "mAP@0.7": 0.41990123715668554}, "receipt_sha256": "c2708e8a90846b2612c3ed18009cc3b85f0fd88de77ab54bd2dfe007a906057f"}, {"completed_epochs": 45, "successful_updates": 4500, "metrics": {"average_mAP": 0.6246047960571048, "mAP@0.3": 0.7721558794803033, "mAP@0.4": 0.7240314521156093, "mAP@0.5": 0.6461079369527816, "mAP@0.6": 0.5568247404734351, "mAP@0.7": 0.4239039712633949}, "receipt_sha256": "14b5e9a8541d0ef28ce6cfd896b4b166de766e3415ce228abc39757b1045b0f7"}, {"completed_epochs": 50, "successful_updates": 5000, "metrics": {"average_mAP": 0.6239277927145912, "mAP@0.3": 0.7701912763474221, "mAP@0.4": 0.7228390445498867, "mAP@0.5": 0.6426789255557395, "mAP@0.6": 0.5564785381708455, "mAP@0.7": 0.4274511789490621}, "receipt_sha256": "b8d6db8f029754b05d7eddc02c7f412999bd219f2f6378222b385bfe501b17f3"}],
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 23:52状态、23:57补收成绩：1280127 RUNNING；全测试已返回第40轮，最佳为第40轮。本轮实际读取新最佳EMA，数值有限、SHA/seed/epoch/指标匹配；远端exact/clean，未发现新增fatal",
            "result_status": "中期测试选模结果（最新评测4000/6000 updates，最佳第40轮）；尚无终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 5.2404%；第10轮 30.9742%；第15轮 38.1240%；第20轮 49.0216%；第25轮 56.7257%；第30轮 60.7207%；第35轮 62.5658%；第40轮 63.4838%；最佳第40轮 63.4838%，对应mAP@0.7为40.4433%。本轮实际读取新最佳EMA，数值有限、SHA/seed/epoch/指标匹配。全部周期及best收据自哈希通过；测试集参与选模，不称独立未见测试泛化",
            "periodic_results": [{"completed_epochs": 5, "successful_updates": 500, "metrics": {"average_mAP": 0.052404388695899265, "mAP@0.3": 0.13454768404769923, "mAP@0.4": 0.07169580001566081, "mAP@0.5": 0.035718115139287736, "mAP@0.6": 0.014319157582992636, "mAP@0.7": 0.005741186693855871}, "receipt_sha256": "757280365f62c14d3008d3092cf12f766fa7997b0e7b1a1f53ca6c843e4fedf1"}, {"completed_epochs": 10, "successful_updates": 1000, "metrics": {"average_mAP": 0.30974169154071707, "mAP@0.3": 0.5410064801219531, "mAP@0.4": 0.4294503995955816, "mAP@0.5": 0.31804857543517384, "mAP@0.6": 0.1815285465486891, "mAP@0.7": 0.07867445600218773}, "receipt_sha256": "95284e1ee73a1e0db56ec4b34db52aa2af72187a8a23b8b19f4476114f151ae2"}, {"completed_epochs": 15, "successful_updates": 1500, "metrics": {"average_mAP": 0.38124046614156004, "mAP@0.3": 0.6302961001712286, "mAP@0.4": 0.5112466078534234, "mAP@0.5": 0.3918618260803822, "mAP@0.6": 0.25280226307016535, "mAP@0.7": 0.11999553353260042}, "receipt_sha256": "68f14e1d49053f20d232ef9f6799be6d4c9ed45cd87b7e9017a7205851265bef"}, {"completed_epochs": 20, "successful_updates": 2000, "metrics": {"average_mAP": 0.49021591988609464, "mAP@0.3": 0.7121690831948745, "mAP@0.4": 0.621414320256948, "mAP@0.5": 0.514721673152809, "mAP@0.6": 0.3766587767166477, "mAP@0.7": 0.22611574610919388}, "receipt_sha256": "8be7bf747d4e47e0434362bb61fece6ceeb1dc0a0c0a20dd260a664fa906a13c"}, {"completed_epochs": 25, "successful_updates": 2500, "metrics": {"average_mAP": 0.5672567482878275, "mAP@0.3": 0.7632559817886055, "mAP@0.4": 0.6955463817215619, "mAP@0.5": 0.5935974989516458, "mAP@0.6": 0.4667000013879294, "mAP@0.7": 0.3171838775893945}, "receipt_sha256": "09eef79d887903612be241ca401cbfbbec3ca15d79a7455cb2828441dc9a6fa0"}, {"completed_epochs": 30, "successful_updates": 3000, "metrics": {"average_mAP": 0.6072066957743136, "mAP@0.3": 0.7851080376682694, "mAP@0.4": 0.7335295740524053, "mAP@0.5": 0.6354272458540635, "mAP@0.6": 0.5166265309175613, "mAP@0.7": 0.36534209037926846}, "receipt_sha256": "72d29618d87e6c6090dc9c21d5e5ec5f5c434e937a42f95e33b530aea4b912a6"}, {"completed_epochs": 35, "successful_updates": 3500, "metrics": {"average_mAP": 0.6256575095240322, "mAP@0.3": 0.7894211399480049, "mAP@0.4": 0.7457313536595424, "mAP@0.5": 0.6539943437256304, "mAP@0.6": 0.5475187223520372, "mAP@0.7": 0.3916219879349463}, "receipt_sha256": "4eab1f5028475505a2af7f8e9e8a5d6f4dd04d2594278c1aea9be8dbfb13a1d3"}, {"completed_epochs": 40, "successful_updates": 4000, "metrics": {"average_mAP": 0.6348380599511808, "mAP@0.3": 0.7921259000941544, "mAP@0.4": 0.7540600600749108, "mAP@0.5": 0.6652546191180359, "mAP@0.6": 0.5583169755138457, "mAP@0.7": 0.404432744954957}, "receipt_sha256": "65a12c6f188cf6cae226dbc74880f0659feb67f80f38f296cc6f5835913f778b"}],
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-UNIFORM_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 39, "completed_epochs": 40, "average_mAP": 0.6348380599511808, "verified_at": "2026-09-08T23:57:53.433238+08:00", "ema_all_finite": True, "identity_matches": True, "verification_reused": False},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 23:52状态、23:57补收成绩：1280128 RUNNING；全测试已返回第40轮，最佳为第40轮。本轮实际读取新最佳EMA，数值有限、SHA/seed/epoch/指标匹配；远端exact/clean，未发现新增fatal",
            "result_status": "中期测试选模结果（最新评测4000/6000 updates，最佳第40轮）；尚无终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 5.4013%；第10轮 30.8467%；第15轮 38.9224%；第20轮 49.1960%；第25轮 55.8911%；第30轮 60.2283%；第35轮 62.1153%；第40轮 63.2568%；最佳第40轮 63.2568%，对应mAP@0.7为40.7670%。本轮实际读取新最佳EMA，数值有限、SHA/seed/epoch/指标匹配。全部周期及best收据自哈希通过；测试集参与选模，不称独立未见测试泛化",
            "periodic_results": [{"completed_epochs": 5, "successful_updates": 500, "metrics": {"average_mAP": 0.05401331500687441, "mAP@0.3": 0.13719553760330278, "mAP@0.4": 0.07794436072943473, "mAP@0.5": 0.03744791790439024, "mAP@0.6": 0.012574480430182283, "mAP@0.7": 0.004904278367062011}, "receipt_sha256": "33a03d72a781dd3e6f6a612997a8e12ae7fb303e194505d7b13088168e828940"}, {"completed_epochs": 10, "successful_updates": 1000, "metrics": {"average_mAP": 0.30846708533218026, "mAP@0.3": 0.5303609492176219, "mAP@0.4": 0.4263265522756014, "mAP@0.5": 0.32134577320690794, "mAP@0.6": 0.1840092457478986, "mAP@0.7": 0.0802929062128714}, "receipt_sha256": "3f8e67ddc2782b3d39754ccd97ae170f7ceb4b442b84c07eff8a3ad1a420efc2"}, {"completed_epochs": 15, "successful_updates": 1500, "metrics": {"average_mAP": 0.389223985462347, "mAP@0.3": 0.6299900419220554, "mAP@0.4": 0.5178839381889356, "mAP@0.5": 0.3957216111943387, "mAP@0.6": 0.26546915209334077, "mAP@0.7": 0.13705518391306432}, "receipt_sha256": "71012477d4e1921ef3ab1c41524a50fbcadae4564f9f1ec62aa1b7142d7cf121"}, {"completed_epochs": 20, "successful_updates": 2000, "metrics": {"average_mAP": 0.49196047559031075, "mAP@0.3": 0.7026205545423906, "mAP@0.4": 0.61779225335978, "mAP@0.5": 0.5165930261542788, "mAP@0.6": 0.38418746590735053, "mAP@0.7": 0.23860907798775371}, "receipt_sha256": "a26c94199f1dc122c7526a6894f70376b712cb09a77a81901e54006424f79919"}, {"completed_epochs": 25, "successful_updates": 2500, "metrics": {"average_mAP": 0.5589109653853758, "mAP@0.3": 0.7456013210263699, "mAP@0.4": 0.680894420713887, "mAP@0.5": 0.5814664875670081, "mAP@0.6": 0.4630812956630743, "mAP@0.7": 0.32351130195653977}, "receipt_sha256": "e08d23d76b33cf0ef76f363f309d8cd53a0aedbd1a05b7ab749a441646adca1e"}, {"completed_epochs": 30, "successful_updates": 3000, "metrics": {"average_mAP": 0.6022834489322624, "mAP@0.3": 0.7740583665427019, "mAP@0.4": 0.7176855758984064, "mAP@0.5": 0.633068667400764, "mAP@0.6": 0.5173632467754427, "mAP@0.7": 0.36924138804399675}, "receipt_sha256": "c46730515ac0e622b22cfc81454ca683956c16937034ceddbd2d8c8085420a18"}, {"completed_epochs": 35, "successful_updates": 3500, "metrics": {"average_mAP": 0.6211531598041058, "mAP@0.3": 0.7836761672633478, "mAP@0.4": 0.7370254257935706, "mAP@0.5": 0.647037463807253, "mAP@0.6": 0.5391425831899123, "mAP@0.7": 0.3988841589664455}, "receipt_sha256": "6ba33e5480140ab924f056aecf60147cad675e565ccc6e13b7cd2991bf16ace8"}, {"completed_epochs": 40, "successful_updates": 4000, "metrics": {"average_mAP": 0.6325676303652403, "mAP@0.3": 0.7903840291825771, "mAP@0.4": 0.7426361241563366, "mAP@0.5": 0.6642430204782789, "mAP@0.6": 0.5579047584347003, "mAP@0.7": 0.4076702195743091}, "receipt_sha256": "63189b80904ab9ee4df376d09e4ba42e5512894a29dd9460c3ddb1605a639ba4"}],
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-PHASEOFF_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 39, "completed_epochs": 40, "average_mAP": 0.6325676303652403, "verified_at": "2026-09-08T23:52:18.479977+08:00", "ema_all_finite": True, "identity_matches": True, "verification_reused": False},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 23:52状态、23:57补收成绩：1280129 RUNNING；全测试已返回第40轮，最佳为第40轮。本轮实际读取新最佳EMA，数值有限、SHA/seed/epoch/指标匹配；远端exact/clean，未发现新增fatal",
            "result_status": "中期测试选模结果（最新评测4000/6000 updates，最佳第40轮）；尚无终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 4.9665%；第10轮 25.6088%；第15轮 32.4714%；第20轮 43.3471%；第25轮 49.1838%；第30轮 52.6773%；第35轮 55.2683%；第40轮 57.0365%；最佳第40轮 57.0365%，对应mAP@0.7为33.4828%。本轮实际读取新最佳EMA，数值有限、SHA/seed/epoch/指标匹配。全部周期及best收据自哈希通过；测试集参与选模，不称独立未见测试泛化",
            "periodic_results": [{"completed_epochs": 5, "successful_updates": 500, "metrics": {"average_mAP": 0.04966518191787468, "mAP@0.3": 0.12300139065143126, "mAP@0.4": 0.07311350935788848, "mAP@0.5": 0.03242899513080873, "mAP@0.6": 0.015001378673652765, "mAP@0.7": 0.004780635775592219}, "receipt_sha256": "d325b9066d0eab01b9e9c977707b76e73b4eb80e17c59e71c200019175b590cf"}, {"completed_epochs": 10, "successful_updates": 1000, "metrics": {"average_mAP": 0.2560878632866976, "mAP@0.3": 0.46837583042276626, "mAP@0.4": 0.36413410089662684, "mAP@0.5": 0.25120170138593023, "mAP@0.6": 0.13805131227254588, "mAP@0.7": 0.05867637145561868}, "receipt_sha256": "389fe89d49d59ce1783179cfc5247536cce128a89099072ee0c06402a5525476"}, {"completed_epochs": 15, "successful_updates": 1500, "metrics": {"average_mAP": 0.3247143964535312, "mAP@0.3": 0.555242967224755, "mAP@0.4": 0.4382651469813627, "mAP@0.5": 0.32429281827207224, "mAP@0.6": 0.20245756367530604, "mAP@0.7": 0.10331348611416002}, "receipt_sha256": "676ce60308351accad2b839c1c3306c638c6eb2e713ec5f1012e71ae7ba2668a"}, {"completed_epochs": 20, "successful_updates": 2000, "metrics": {"average_mAP": 0.433470747904412, "mAP@0.3": 0.6523537461481881, "mAP@0.4": 0.5557140968291572, "mAP@0.5": 0.45063715791097475, "mAP@0.6": 0.3199008351358626, "mAP@0.7": 0.18874790349787718}, "receipt_sha256": "f3fafcf3dd0871e95ad80104f0b5bf9f810d160d4f49fa4f6411abbd46b4e3b0"}, {"completed_epochs": 25, "successful_updates": 2500, "metrics": {"average_mAP": 0.49183822818487943, "mAP@0.3": 0.7006103640745414, "mAP@0.4": 0.6199100847329555, "mAP@0.5": 0.5083788841905919, "mAP@0.6": 0.38470498639944256, "mAP@0.7": 0.2455868215268659}, "receipt_sha256": "60cbef35bd27dbeef9f8dc296d9fca06526bba422c394b7b077bcaed35a47e0b"}, {"completed_epochs": 30, "successful_updates": 3000, "metrics": {"average_mAP": 0.5267727933513344, "mAP@0.3": 0.7212294215422865, "mAP@0.4": 0.6455769671735027, "mAP@0.5": 0.552338160679352, "mAP@0.6": 0.4255715341143729, "mAP@0.7": 0.289147883247158}, "receipt_sha256": "0a8cb947156a307e4acff406b31b221b9a31e6dc915096c4ca819084f8117cfa"}, {"completed_epochs": 35, "successful_updates": 3500, "metrics": {"average_mAP": 0.5526826465052286, "mAP@0.3": 0.7390943558027386, "mAP@0.4": 0.6788987434069627, "mAP@0.5": 0.578856555632649, "mAP@0.6": 0.45052538459794456, "mAP@0.7": 0.31603819308584746}, "receipt_sha256": "6e662d0f61bc5b8f2227b84ae1531f11176b47fdb0af8d47360c081b497c1387"}, {"completed_epochs": 40, "successful_updates": 4000, "metrics": {"average_mAP": 0.5703645506456223, "mAP@0.3": 0.7512228610387873, "mAP@0.4": 0.6925909378789413, "mAP@0.5": 0.5956650140296065, "mAP@0.6": 0.4775161509796309, "mAP@0.7": 0.334827789301145}, "receipt_sha256": "7ac310014698b10e29051ea7ada8fac0538de15aa18864c71f977d62a894edb6"}],
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-PHASEON_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 39, "completed_epochs": 40, "average_mAP": 0.5703645506456223, "verified_at": "2026-09-08T23:52:20.120107+08:00", "ema_all_finite": True, "identity_matches": True, "verification_reused": False},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 23:45-23:52：signed1280314和control/fulltia链1280316均RUNNING，start22:01:16。原始stdout均进入epoch12，审计均1200成功更新。链日志第440行仅h65_matched_arm='control'，没有fulltia启动证据；不因job名含fulltia而误报第三臂开训。预检1280306既有通过证据复用，不重复",
            "result_status": "Stage2第5/10轮已有日志曲线，尚无终态；独立历史30+60复现协议",
            "final_result": "共享30轮Stage1 EMA后重新初始化optimizer执行60轮Stage2，以终态为主。signed第5/10轮日志Avg-mAP60.14%/60.52%；control为60.04%/61.09%。这是四舍五入日志中期值，尚未作为独立收据封存结果；不与本任务strict60测试选best混为一组。signed/control更新审计1200一致，fulltia仍待链内启动",
            "next_action": "由原任务继续已启动的signed与control及后续fulltia链，读取五轮曲线和独立终态；复用1280306已通过预检，不重复提交。仍须补GitHub发布，不能与本任务strict60测试选best结果混为一个协议",
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {"checked_at_cst": "2026-09-08 23:52 CST", "public_gpu_available": 8, "public_gpu_total": 200, "gpu_count_basis": "可见25节点CfgTRES200、AllocTRES192；排除DOWN/DRAIN/FAIL/POWER/UNKNOWN状态；公共余量不代表账户配额", "user_jobs_in_queue": 16, "account_constraint": "10 RUNNING/6 PENDING；本任务ON完成、其余4项RUNNING，另一任务H65两项RUNNING；其他项目不操作。实验盘133.6GiB可用"},
        ...
        "heartbeat_evidence": "34_HEARTBEAT_EVIDENCE_20260908_2343.json",
        "performance_cause_audit_scope": "2026-09-08 23:45-23:57核查：ET新ON完成60轮，最佳55.3617%、终轮训练内54.5976%，373个optimizer state实际6000；尚缺新SHA独立terminal receipt。H65第40轮均匀/相位关/四相开63.4838%/63.2568%/57.0365%；实际最佳EMA核验通过。历史H65链仍为control，fulltia未启动。未发现新增fatal、未调参或重提",
...
def md_text(payload: dict[str, Any]) -> str:
    ...
    lines += [
        ...
        "## 监督器与动态状态",
        "",
        f"远端 N16R4 监督器恢复目录：`{REMOTE_ROOT}`，每60秒轮询；本地heartbeat每30分钟刷新本表并用中文详细通知用户，即使无变化。当前回执状态：`{payload['remote_supervisor'].get('status')}`，距生成`{payload['remote_supervisor'].get('receipt_age_seconds', '未知')}`秒；dispatcher：`{payload['remote_supervisor'].get('dispatcher_status', '未知')}`，mode：`{payload['remote_supervisor'].get('dispatcher_mode', '未知')}`。旧进程因磁盘配额退出的日志保留；新进程恢复只读轮询，超过180秒标STALE。dispatcher不自动续提当前修复队列。17:21/17:26由监督任务提交的5项新协议作业当前状态见独立行，部署身份见29号记录；本轮ET开启组训练及12次全测试完成，独立终态封存仍待补，见34号记录。未新增提交、取消或改参。不是分钟dispatcher自动提交。已有Computer Use初始化阻塞仍保留，本轮未咨询Pro，也未取消旧任务。",
        "",
