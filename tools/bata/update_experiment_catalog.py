...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 03:24-03:26：629162cd三项均COMPLETED，终轮均匀/相位关/四相开63.8596%/64.2632%/57.4857%，最佳63.9646%(50)/64.2632%(60)/57.5081%(55)。三份epoch59实际有限，global optimizer/scheduler及落盘EMA/DUCA schedule6000；少步参数分布单列，不称全部参数6000。新独立terminal receipt待补。历史90轮两项仍p_action非有限FAILED，未接管重提",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 03:26：独立收据绑定fe1c53db/07383274且自哈希有效。均匀G0 64.2720%、双相动态G1 61.6740%未变；不是完整B-AMoD矩阵，也不是原始官方AdaTAD替代。后续机制矩阵eval5仍待接入",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 03:23心跳本地状态随目录刷新，尚无新增正式结果；0fcef0bf时间轴接线修复不代表Taylor P0/P1、合法one-swap和H65 retention/transition完成，继续BLOCKED_UNIMPLEMENTED",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 03:26：710ce8a6五份terminal仍存在，新metrics仍0，FULL仍仅PRECHECK。后继b142bffa已修padding接线但terminal screen/eval5/生产验证未完成；不扩错误旧矩阵，不操作历史1267920/1267921",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 03:24：ON/OFF仍COMPLETED，12次曲线完整；最佳55.3617%/62.5093%，终轮54.5976%/61.7587%，数据未变。实际terminal认证复用34/35号；两份新独立terminal receipt仍未生成。本轮没有重复训练、准入、改参或Pro咨询",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 03:26：旧A1 metrics.average_mAP仍0.5159681679375281，原收据键为evaluation_sha256；F/A6独立metrics仍缺。旧结果不能迁移为79aea08a修复版性能；utility/真实two-view/cycle及eval5仍待落实",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 03:24-03:26实际核查：1280117 COMPLETED(0:0)，结束2026-09-08T23:23:38，耗时06:02:07；60轮训练及全部12次完整测试完成。远端exact/clean，stdout/stderr无新fatal。复用34/35号终态实际权重认证，不重复加载未变大文件",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 03:24-03:26实际核查：1280118 COMPLETED(0:0)，结束2026-09-09T01:17:13，耗时07:55:42；60轮训练及全部12次完整测试完成。远端exact/clean，stdout/stderr无新fatal。复用34/35号终态实际权重认证，不重复加载未变大文件",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 03:24-03:26实际核查：1280127 COMPLETED(0:0)，结束2026-09-09T03:16:51，耗时09:50:50；60轮训练及全部12次完整测试完成。远端exact/clean，stdout/stderr无新fatal。首次读取本SHA终态EMA；全局成功更新6000，参数参与步数另列",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 03:24-03:26实际核查：1280128 COMPLETED(0:0)，结束2026-09-09T03:03:33，耗时09:37:32；60轮训练及全部12次完整测试完成。远端exact/clean，stdout/stderr无新fatal。首次读取本SHA终态EMA；全局成功更新6000，参数参与步数另列",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 03:24-03:26实际核查：1280129 COMPLETED(0:0)，结束2026-09-09T02:45:42，耗时09:19:41；60轮训练及全部12次完整测试完成。远端exact/clean，stdout/stderr无新fatal。首次读取本SHA终态EMA；全局成功更新6000，参数参与步数另列",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 03:26再次实际核查：signed1280314/control链1280316仍FAILED(1:0)；stdout/stderr末端仍为epoch16 AMP replay后p_action非有限，未见fulltia正式启动或新恢复作业。35号已保存完整失败定位，旧job/log/checkpoint保留，本任务未接管或重提",
            ...
            "open_failure": {"state": "OPEN_NUMERICAL_ROOT_CAUSE_PENDING", "jobs": ["1280314", "1280316"], "source_sha": "96e5b3a5e9d77d65b7a0afca86277261dd63295b", "throw_site": "opentad/models/duca/acquisition.py:2042", "message": "p_action calibration check received non-finite values", "last_persisted_successful_updates": 1600, "logs": [{"job": "1280314", "stdout": "/data/run01/sczc063/yuzibo/experiments/h65_matched_96e5b3a5_seed3407/logs/signed_1280314.out", "stderr": "/data/run01/sczc063/yuzibo/experiments/h65_matched_96e5b3a5_seed3407/logs/signed_1280314.err"}, {"job": "1280316", "stdout": "/data/run01/sczc063/yuzibo/experiments/h65_matched_96e5b3a5_seed3407/logs/control_fulltia_1280316.out", "stderr": "/data/run01/sczc063/yuzibo/experiments/h65_matched_96e5b3a5_seed3407/logs/control_fulltia_1280316.err"}], "retry_submitted": False, "owner_notified_via_thread_tool": False, "note": "Thread coordination tool unavailable in this turn; recorded in shared catalog, not claimed delivered to the owner.", "last_rechecked_at": "2026-09-09T03:26:45.976401+08:00"},
        },
        {
            "category": "related_task_repair",
            "github_commit": None,
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {"checked_at_cst": "2026-09-09 03:26 CST", "public_gpu_available": 55, "public_gpu_total": 200, "gpu_count_basis": "scontrol CfgTRES/AllocTRES，排除DOWN/DRAIN/FAIL/UNKNOWN/FUTURE；公共余量不保证个人即时配额", "user_jobs_in_queue": 3, "account_constraint": "1 RUNNING/2 PENDING，均为其他项目；本任务五项新训练全部完成，没有仍运行或排队的本轮训练。剩余阻碍是独立评测及实现缺项，不是这五项等待GPU。实验盘121.83GiB可用"},
        ...
        "heartbeat_evidence": "36_HEARTBEAT_EVIDENCE_20260909_0323.json",
        "performance_cause_audit_scope": "2026-09-09 03:24-03:26核查：五项新训练全部COMPLETED、60份完整测试收据齐全。H65终轮均匀/相位关/四相开63.8596%/64.2632%/57.4857%，相位关第60轮新best真实EMA认证通过。三份H65全局6000、EMA有限，参数少步分布如实另列。ET及CT分数未变；历史90轮两项数值失败保留。没有新模型修复或自动重提",
...
def md_text(payload: dict[str, Any]) -> str:
    ...
    lines += [
        ...
        "## 监督器与动态状态",
        "",
        f"远端 N16R4 监督器恢复目录：`{REMOTE_ROOT}`，每60秒轮询；本地heartbeat每30分钟刷新本表并用中文详细通知用户，即使无变化。当前回执状态：`{payload['remote_supervisor'].get('status')}`，距生成`{payload['remote_supervisor'].get('receipt_age_seconds', '未知')}`秒；dispatcher：`{payload['remote_supervisor'].get('dispatcher_status', '未知')}`，mode：`{payload['remote_supervisor'].get('dispatcher_mode', '未知')}`。旧进程因磁盘配额退出的日志保留；新进程恢复只读轮询，超过180秒标STALE。dispatcher不自动续提当前修复队列。17:21/17:26由监督任务提交的5项新协议作业当前状态见独立行，部署身份见29号记录；本轮03:23心跳已确认ET两项和H65三项全部完成、共60次全测试齐全；独立终态封存仍待补，旧90轮两项数值失败未恢复，见36号记录。未新增提交、取消或改参。不是分钟dispatcher自动提交。已有Computer Use初始化阻塞仍保留，本轮未咨询Pro，也未取消旧任务。",
        "",
