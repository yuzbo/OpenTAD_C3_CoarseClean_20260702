...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 04:15实际复核：629162cd三项仍COMPLETED；终轮均匀/相位关/四相开63.8596%/64.2632%/57.4857%，最佳63.9646%(50)/64.2632%(60)/57.5081%(55)。周期/best收据有效，epoch59/best文件大小及mtime未变，复用36号实际EMA与全局6000认证；少步参数归属仍未认证。独立终态评测待补；历史90轮两项仍数值失败",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 04:16：fe1c53db/07383274独立收据与自哈希有效，均匀G0 64.2720%、双相动态G1 61.6740%不变。当前这对几何对照不代表完整B-AMoD矩阵或原始官方AdaTAD；后续机制矩阵eval5仍待接入",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 04:15-04:16性能检查：没有新正式结果；本地身份随目录刷新。0fcef0bf时间轴接线不等于Taylor P0/P1、合法one-swap或H65 retention/transition完成，继续BLOCKED_UNIMPLEMENTED",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 04:16：710ce8a6五份terminal仍在，新metrics仍0，FULL仍仅PRECHECK；后继b142bffa padding接线修复的生产screen/eval5仍待完成。旧更新数违规成绩不能作为修复版性能；历史1267920/1267921保持只读",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 04:15：ON/OFF仍COMPLETED，各12次全测试齐全；最佳55.3617%/62.5093%，终轮54.5976%/61.7587%。收据有效、终态和best文件stat未变，复用34/35号实际权重认证；新独立terminal receipt仍缺。本次仅检查，没有改模型、调参或新提交",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-09 04:16：旧A1 Avg-mAP仍51.5968%，按真实evaluation_sha256键重新核验原收据PASS。F/A6独立metrics仍缺；79aea08a接线修复不能继承旧分数，也未补齐utility/真实two-view/cycle及eval5",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 04:15实际核查：1280117仍COMPLETED(0:0)，60轮及全部12次完整测试完成。远端exact/clean，stdout终末Training Over且stderr正常结束，60份周期与5份best收据均有效。本臂终态/best的大小及mtime未变，沿用34/35/36号实际权重认证而非本轮重新加载；独立终态评测仍待补",
            ...
            "next_action": "保留最佳与终轮、全部12次曲线。补9a346f0d独立终态评测绑定；完整配对已显示近似开启组最佳低7.1476点、终轮低7.1612点，优先定位近似机制及训练配方，不把负结果归于未完成或资源不足。未在本轮调参或重训；未来调整保留全部尝试。",
        },
        {
            "category": "test_guided_exploratory",
            ...
            "deployment_status": "2026-09-09 04:15实际核查：1280118仍COMPLETED(0:0)，60轮及全部12次完整测试完成。远端exact/clean，stdout终末Training Over且stderr正常结束，60份周期与5份best收据均有效。本臂终态/best的大小及mtime未变，沿用34/35/36号实际权重认证而非本轮重新加载；独立终态评测仍待补",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 04:15实际核查：1280127仍COMPLETED(0:0)，60轮及全部12次完整测试完成。远端exact/clean，stdout终末Training Over且stderr正常结束，60份周期与5份best收据均有效。本臂终态/best的大小及mtime未变，沿用34/35/36号实际权重认证而非本轮重新加载；独立终态评测仍待补",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 04:15实际核查：1280128仍COMPLETED(0:0)，60轮及全部12次完整测试完成。远端exact/clean，stdout终末Training Over且stderr正常结束，60份周期与5份best收据均有效。本臂终态/best的大小及mtime未变，沿用34/35/36号实际权重认证而非本轮重新加载；独立终态评测仍待补",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 04:15实际核查：1280129仍COMPLETED(0:0)，60轮及全部12次完整测试完成。远端exact/clean，stdout终末Training Over且stderr正常结束，60份周期与5份best收据均有效。本臂终态/best的大小及mtime未变，沿用34/35/36号实际权重认证而非本轮重新加载；独立终态评测仍待补",
            "result_status": "60轮训练与12次全测试完成；测试集选模最佳及训练内终轮成绩可报告，独立终态receipt仍待补",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-09 04:16实际复核：signed1280314/control链1280316仍FAILED(1:0)，已再次读取对应stdout/stderr，末端仍为epoch16 AMP replay后p_action非有限。未见本登记命名空间的fulltia正式启动或恢复结果；35号完整日志与checkpoint保留，本任务未接管或盲目重提",
            ...
            "open_failure": {"state":"OPEN_NUMERICAL_ROOT_CAUSE_PENDING","jobs":["1280314","1280316"],"source_sha":"96e5b3a5e9d77d65b7a0afca86277261dd63295b","throw_site":"opentad/models/duca/acquisition.py:2042","message":"p_action calibration check received non-finite values","last_persisted_successful_updates":1600,"logs":[{"job":"1280314","stdout":"/data/run01/sczc063/yuzibo/experiments/h65_matched_96e5b3a5_seed3407/logs/signed_1280314.out","stderr":"/data/run01/sczc063/yuzibo/experiments/h65_matched_96e5b3a5_seed3407/logs/signed_1280314.err"},{"job":"1280316","stdout":"/data/run01/sczc063/yuzibo/experiments/h65_matched_96e5b3a5_seed3407/logs/control_fulltia_1280316.out","stderr":"/data/run01/sczc063/yuzibo/experiments/h65_matched_96e5b3a5_seed3407/logs/control_fulltia_1280316.err"}],"retry_submitted": False,"owner_notified_via_thread_tool": False,"note":"Thread coordination tool unavailable in this turn; recorded in shared catalog, not claimed delivered to the owner.","last_rechecked_at":"2026-09-09T04:16:38.281884+08:00"},
        },
        {
            "category": "related_task_repair",
            "github_commit": None,
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {"checked_at_cst":"2026-09-09 04:16 CST","public_gpu_available":51,"public_gpu_total":200,"gpu_count_basis":"scontrol CfgTRES/AllocTRES，排除DOWN/DRAIN/FAIL/UNKNOWN/POWERED_DOWN；公共余量不保证个人即时配额","user_jobs_in_queue":4,"account_constraint":"1 RUNNING/3 PENDING，均非本次五项新训练；这五项均已完成。当前缺的是独立终态评测和剩余机制/修复验证，不是等待GPU完成这些训练。实验盘121.60GiB可用"},
        ...
        "heartbeat_evidence": "37_PERFORMANCE_CHECK_20260909_0415.json",
        "performance_cause_audit_scope": "2026-09-09 04:15-04:16用户请求的实时性能检查：五项60轮训练完成、60份全测试与5份best收据有效、文件stat未变；沿用已有实际权重/6000更新认证。H65四相开比关最佳低6.7550点，ET近似开比关最佳低7.1476点；不是训练没跑完。CT最高仍64.2720%，旧A1 evaluation_sha256有效；其余缺项及历史90轮数值失败未解决。本次未改模型、调参或新部署",
...
def md_text(payload: dict[str, Any]) -> str:
    ...
    lines += [
        ...
        "## 监督器与动态状态",
        "",
        f"远端 N16R4 监督器恢复目录：`{REMOTE_ROOT}`，每60秒轮询；本地heartbeat每30分钟刷新本表并用中文详细通知用户，即使无变化。当前回执状态：`{payload['remote_supervisor'].get('status')}`，距生成`{payload['remote_supervisor'].get('receipt_age_seconds', '未知')}`秒；dispatcher：`{payload['remote_supervisor'].get('dispatcher_status', '未知')}`，mode：`{payload['remote_supervisor'].get('dispatcher_mode', '未知')}`。旧进程因磁盘配额退出的日志保留；新进程恢复只读轮询，超过180秒标STALE。dispatcher不自动续提当前修复队列。17:21/17:26由监督任务提交的5项新协议作业当前状态见独立行，部署身份见29号记录；本轮04:15-04:16为用户请求的实时性能检查，确认ET两项和H65三项全部完成、共60次全测试齐全；最佳和终轮分数未变。独立终态封存仍待补，旧90轮两项数值失败未恢复，见37号记录；不把交互检查补记为历史心跳。未新增提交、取消或改参。不是分钟dispatcher自动提交。已有Computer Use初始化阻塞仍保留，本轮未咨询Pro，也未取消旧任务。",
        "",
