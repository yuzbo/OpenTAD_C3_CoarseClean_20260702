...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 18:25 CST：新629162cd三项1280127/1280128/1280129均RUNNING，完成第5轮全测试。均匀/相位关/四相开Avg-mAP为5.2404%/5.4013%/4.9665%，均500次成功更新；最佳EMA实际权重与收据身份核对通过。属于早期曲线，不是最终性能。初始2/3/2次AMP skip均replay，无预算丢失或replay耗尽",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 18:20 CST：1278011/1278012及1279211_0/1均COMPLETED(0:0)，终态文件保留，G0/G1官方Avg-mAP仍64.2720%/61.6740%。日志为optimizer/scheduler/EMA各6000，未见新增fatal；复用此前实际337个Adam状态及receipt认证，不重复加载或训练。后续未运行矩阵的eval5尚未接入",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 18:20 CST：本地793c4f9c仍clean，无正式作业；Taylor P0/P1、合法one-swap及H65 retention/transition仍未实现。分钟监督器新鲜但dispatcher为plan/BLOCKED，不会自动解锁或提交这些缺失机制",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 18:20 CST：teacher/G96/U16/LATE/NOKD五个epoch59文件仍在，新710ce8a6无metrics文件；已查U16/LATE/NOKD与FULL PRECHECK日志，未见新增fatal。FULL仍只是1277955 PRECHECK完成，非正式训练。padding、真实终态screen和专用训练器eval5尚未完成，不把旧无效成绩迁移为新结果；历史1267920/1267921未操作",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 18:25 CST：新ON1280117/OFF1280118均RUNNING；全测试第5轮5.7073%/4.2952%，第10轮升至32.0496%/33.7828%。两者最佳均第10轮、1000次更新；实际最佳EMA的权重有限，SHA/seed/轮次指标一致。只是中期测试选模结果，本轮未据此调参或重训",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 18:20 CST：旧ce767b4d的A1/A6/F终态保留，相关训练与A1评测作业均COMPLETED(0:0)，所查日志未见新增fatal。A1官方Avg-mAP仍51.5968%；F/A6尚无独立receipt。新e0c88c9a只修refiner初始化，utility/真实robust/cycle及eval5仍待完成，未新增正式训练",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 18:25 CST：1280117 RUNNING；2 GPU。完成第10轮全测试并已保存最佳EMA；原exact-SHA CUDA/PRECHECK结果复用，不重复准入",
            "result_status": "中期测试选模结果（1000/6000 updates）；未完成正式训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 5.7073%；第10轮 32.0496%；当前最佳第10轮 32.0496%。最佳EMA真实权重有限、SHA/seed及对应轮次收据一致，自哈希通过。测试集参与选模，不能称独立未见测试成绩；epoch59 EMA终态另报",
            ...
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/ettrc_anchor_eval5_9a346f0d_seed4407/formal/on/gpu2_id0/test_guided/best_test.pth", "epoch": 9, "completed_epochs": 10, "average_mAP": 0.320496021124476, "verified_at": "2026-09-08T18:25:15+08:00", "ema_all_finite": True, "identity_matches": True},
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 18:25 CST：1280118 RUNNING；2 GPU。完成第10轮全测试并已保存最佳EMA；原exact-SHA CUDA/PRECHECK结果复用，不重复准入",
            "result_status": "中期测试选模结果（1000/6000 updates）；未完成正式训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 4.2952%；第10轮 33.7828%；当前最佳第10轮 33.7828%。最佳EMA真实权重有限、SHA/seed及对应轮次收据一致，自哈希通过。测试集参与选模，不能称独立未见测试成绩；epoch59 EMA终态另报",
            "periodic_results": [{"completed_epochs": 5, "successful_updates": 500, "metrics": {"average_mAP": 0.04295212049884119, "mAP@0.3": 0.11231359964095504, "mAP@0.4": 0.06323970506636518, "mAP@0.5": 0.026467493009795222, "mAP@0.6": 0.009421238730616236, "mAP@0.7": 0.0033185660464742452}, "receipt_sha256": "2f47ae495364a78c0a2a5160b32e8cb7df75f32accb9c0ef7beaaf53837f0eee"}, {"completed_epochs": 10, "successful_updates": 1000, "metrics": {"average_mAP": 0.33782786747424576, "mAP@0.3": 0.5309770686836096, "mAP@0.4": 0.4461896590140941, "mAP@0.5": 0.3584564154180127, "mAP@0.6": 0.2306159555735646, "mAP@0.7": 0.12290023868194773}, "receipt_sha256": "bd391ac823db6941249a4b5469765326d7705e6819f5ca473f47390b9a71b27c"}],
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/ettrc_anchor_eval5_9a346f0d_seed4407/formal/off/gpu2_id0/test_guided/best_test.pth", "epoch": 9, "completed_epochs": 10, "average_mAP": 0.33782786747424576, "verified_at": "2026-09-08T18:25:15+08:00", "ema_all_finite": True, "identity_matches": True},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 18:25 CST：1280127 RUNNING；1 GPU。完成第5轮全测试并已保存最佳EMA；原exact-SHA CUDA/PRECHECK结果复用，不重复准入",
            "result_status": "中期测试选模结果（500/6000 updates）；未完成正式训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 5.2404%；当前最佳第5轮 5.2404%。最佳EMA真实权重有限、SHA/seed及对应轮次收据一致，自哈希通过。测试集参与选模，不能称独立未见测试成绩；epoch59 EMA终态另报",
            ...
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-UNIFORM_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 4, "completed_epochs": 5, "average_mAP": 0.052404388695899265, "verified_at": "2026-09-08T18:25:15+08:00", "ema_all_finite": True, "identity_matches": True},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 18:25 CST：1280128 RUNNING；1 GPU。完成第5轮全测试并已保存最佳EMA；原exact-SHA CUDA/PRECHECK结果复用，不重复准入",
            "result_status": "中期测试选模结果（500/6000 updates）；未完成正式训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 5.4013%；当前最佳第5轮 5.4013%。最佳EMA真实权重有限、SHA/seed及对应轮次收据一致，自哈希通过。测试集参与选模，不能称独立未见测试成绩；epoch59 EMA终态另报",
            ...
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-PHASEOFF_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 4, "completed_epochs": 5, "average_mAP": 0.05401331500687441, "verified_at": "2026-09-08T18:25:15+08:00", "ema_all_finite": True, "identity_matches": True},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 18:25 CST：1280129 RUNNING；1 GPU。完成第5轮全测试并已保存最佳EMA；原exact-SHA CUDA/PRECHECK结果复用，不重复准入",
            "result_status": "中期测试选模结果（500/6000 updates）；未完成正式训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 4.9665%；当前最佳第5轮 4.9665%。最佳EMA真实权重有限、SHA/seed及对应轮次收据一致，自哈希通过。测试集参与选模，不能称独立未见测试成绩；epoch59 EMA终态另报",
            "periodic_results": [{"completed_epochs": 5, "successful_updates": 500, "metrics": {"average_mAP": 0.04966518191787468, "mAP@0.3": 0.12300139065143126, "mAP@0.4": 0.07311350935788848, "mAP@0.5": 0.03242899513080873, "mAP@0.6": 0.015001378673652765, "mAP@0.7": 0.004780635775592219}, "receipt_sha256": "d325b9066d0eab01b9e9c977707b76e73b4eb80e17c59e71c200019175b590cf"}],
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-PHASEON_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 4, "completed_epochs": 5, "average_mAP": 0.04966518191787468, "verified_at": "2026-09-08T18:25:15+08:00", "ema_all_finite": True, "identity_matches": True},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
    ]
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {"checked_at_cst": "2026-09-08 18:20:44 CST", "public_gpu_available": 0, "public_gpu_total": 200, "gpu_count_basis": "排除DOWN/DRAIN/FAIL/MAINT/RESERVED/NOT_RESPONDING后可见节点CfgTRES200、AllocTRES200；公共未分配数不等于账户配额", "user_jobs_in_queue": 10, "account_constraint": "8 RUNNING/2 PENDING，两个PENDING均JobHeldUser；本任务新五项仍RUNNING，其余任务不操作。磁盘剩余163.2GiB。18:25五项最佳EMA真实文件有限且身份一致；尚未到epoch59"},
        ...
        "heartbeat_evidence": "30_TEST_GUIDED_EVAL5_PROGRESS_20260908_1825.json",
        "performance_cause_audit_scope": "2026-09-08 18:25核对新协议五项训练与最佳EMA：ET第10轮ON/OFF为32.0496%/33.7828%，H65第5轮三组为5.2404%/5.4013%/4.9665%。所有新分数是测试参与选模的中期结果；五个实际EMA权重及对应收据身份通过核对。没有新终态结果，本轮未调参、未重训，也未重复已通过的准入。其他四路线的未完成项继续明确列示",
