...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 19:06 CST：新629162cd三项1280127/1280128/1280129均RUNNING，第10轮全测试均匀/相位关/四相开Avg-mAP为30.9742%/30.8467%/25.6088%；当前最佳均第10轮、评测时1000成功更新。日志仍有限、无新fatal；审计最新1000/1000/1100次成功更新，累计3/3/2次AMP skip均replay。四相组中期落后均匀5.37点，不作终态裁决",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 19:06-19:10 CST：G0/G1训练及独立评测仍COMPLETED(0:0)，两份终态文件保留，官方Avg-mAP仍64.2720%/61.6740%。源代码exact/clean、metrics身份路径与数值未变；复用此前6000更新及receipt认证，不重复加载或评测。后续未运行机制矩阵的eval5尚待接入",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 19:06 CST：本地793c4f9c仍clean，无正式作业；真实Taylor P0/P1、合法one-swap、H65 retention/transition仍未实现。分钟轮询回执约60秒新鲜，dispatcher仍plan/BLOCKED，不能把它当自动训练部署成功",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 19:06-19:10 CST：teacher/G96/U16/LATE/NOKD五个epoch59文件保留，相关作业仍COMPLETED，新710ce8a6没有独立metrics；FULL仍只有PRECHECK。padding、真实终态screen和专用训练器eval5未完成，本轮不以旧SHA追加正式训练。历史1267920/1267921未操作",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 19:06 CST：新ON1280117/OFF1280118均RUNNING，训练已到epoch18末；第15轮全测试为42.1020%/42.7081%，当前最佳均第15轮、评测时1500更新。近似组平均低0.61点，但mAP@0.7高0.65点；仍是早期单种子曲线，不是终态提升或失败证明。实际新最佳EMA与收据一致，无新fatal",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 19:06-19:10 CST：旧ce767b4d的A1/A6/F终态文件保留，相关作业仍COMPLETED，A1 Avg-mAP51.5968%未变；F/A6尚无独立receipt。新e0c88c9a exact/clean但仅修refiner初始化，utility/真实robust/cycle及eval5未完成；本轮没有新增正式结果",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 19:06 CST：1280117 RUNNING；完成第15轮全测试并保存新最佳EMA。19:07实际最佳EMA权重和对应轮次收据一致；源代码exact/clean，无新fatal",
            "result_status": "中期测试选模结果（评测时1500/6000 updates）；未完成训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 5.7073%；第10轮 32.0496%；第15轮 42.1020%；当前最佳第15轮 42.1020%，mAP@0.7为18.2256%。实际最佳EMA权重有限、SHA/seed及轮次指标一致，现有自哈希通过。测试参与选模，不称独立未见测试泛化；终态epoch59 EMA另报",
            ...
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/ettrc_anchor_eval5_9a346f0d_seed4407/formal/on/gpu2_id0/test_guided/best_test.pth", "epoch": 14, "completed_epochs": 15, "average_mAP": 0.4210201639208712, "verified_at": "2026-09-08T19:07:42+08:00", "ema_all_finite": True, "identity_matches": True},
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 19:06 CST：1280118 RUNNING；完成第15轮全测试并保存新最佳EMA。19:07实际最佳EMA权重和对应轮次收据一致；源代码exact/clean，无新fatal",
            "result_status": "中期测试选模结果（评测时1500/6000 updates）；未完成训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 4.2952%；第10轮 33.7828%；第15轮 42.7081%；当前最佳第15轮 42.7081%，mAP@0.7为17.5803%。实际最佳EMA权重有限、SHA/seed及轮次指标一致，现有自哈希通过。测试参与选模，不称独立未见测试泛化；终态epoch59 EMA另报",
            ...
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/ettrc_anchor_eval5_9a346f0d_seed4407/formal/off/gpu2_id0/test_guided/best_test.pth", "epoch": 14, "completed_epochs": 15, "average_mAP": 0.42708126331904783, "verified_at": "2026-09-08T19:07:42+08:00", "ema_all_finite": True, "identity_matches": True},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 19:06 CST：1280127 RUNNING；完成第10轮全测试并保存新最佳EMA。19:07实际最佳EMA权重和对应轮次收据一致；源代码exact/clean，无新fatal",
            "result_status": "中期测试选模结果（评测时1000/6000 updates）；未完成训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 5.2404%；第10轮 30.9742%；当前最佳第10轮 30.9742%，mAP@0.7为7.8674%。实际最佳EMA权重有限、SHA/seed及轮次指标一致，现有自哈希通过。测试参与选模，不称独立未见测试泛化；终态epoch59 EMA另报",
            "periodic_results": [{"completed_epochs": 5, "successful_updates": 500, "metrics": {"average_mAP": 0.052404388695899265, "mAP@0.3": 0.13454768404769923, "mAP@0.4": 0.07169580001566081, "mAP@0.5": 0.035718115139287736, "mAP@0.6": 0.014319157582992636, "mAP@0.7": 0.005741186693855871}, "receipt_sha256": "757280365f62c14d3008d3092cf12f766fa7997b0e7b1a1f53ca6c843e4fedf1"}, {"completed_epochs": 10, "successful_updates": 1000, "metrics": {"average_mAP": 0.30974169154071707, "mAP@0.3": 0.5410064801219531, "mAP@0.4": 0.4294503995955816, "mAP@0.5": 0.31804857543517384, "mAP@0.6": 0.1815285465486891, "mAP@0.7": 0.07867445600218773}, "receipt_sha256": "95284e1ee73a1e0db56ec4b34db52aa2af72187a8a23b8b19f4476114f151ae2"}],
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-UNIFORM_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 9, "completed_epochs": 10, "average_mAP": 0.30974169154071707, "verified_at": "2026-09-08T19:07:42+08:00", "ema_all_finite": True, "identity_matches": True},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 19:06 CST：1280128 RUNNING；完成第10轮全测试并保存新最佳EMA。19:07实际最佳EMA权重和对应轮次收据一致；源代码exact/clean，无新fatal",
            "result_status": "中期测试选模结果（评测时1000/6000 updates）；未完成训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 5.4013%；第10轮 30.8467%；当前最佳第10轮 30.8467%，mAP@0.7为8.0293%。实际最佳EMA权重有限、SHA/seed及轮次指标一致，现有自哈希通过。测试参与选模，不称独立未见测试泛化；终态epoch59 EMA另报",
            ...
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-PHASEOFF_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 9, "completed_epochs": 10, "average_mAP": 0.30846708533218026, "verified_at": "2026-09-08T19:07:42+08:00", "ema_all_finite": True, "identity_matches": True},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 19:06 CST：1280129 RUNNING；完成第10轮全测试并保存新最佳EMA。19:07实际最佳EMA权重和对应轮次收据一致；源代码exact/clean，无新fatal",
            "result_status": "中期测试选模结果（评测时1000/6000 updates）；未完成训练终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 4.9665%；第10轮 25.6088%；当前最佳第10轮 25.6088%，mAP@0.7为5.8676%。实际最佳EMA权重有限、SHA/seed及轮次指标一致，现有自哈希通过。测试参与选模，不称独立未见测试泛化；终态epoch59 EMA另报",
            "periodic_results": [{"completed_epochs": 5, "successful_updates": 500, "metrics": {"average_mAP": 0.04966518191787468, "mAP@0.3": 0.12300139065143126, "mAP@0.4": 0.07311350935788848, "mAP@0.5": 0.03242899513080873, "mAP@0.6": 0.015001378673652765, "mAP@0.7": 0.004780635775592219}, "receipt_sha256": "d325b9066d0eab01b9e9c977707b76e73b4eb80e17c59e71c200019175b590cf"}, {"completed_epochs": 10, "successful_updates": 1000, "metrics": {"average_mAP": 0.2560878632866976, "mAP@0.3": 0.46837583042276626, "mAP@0.4": 0.36413410089662684, "mAP@0.5": 0.25120170138593023, "mAP@0.6": 0.13805131227254588, "mAP@0.7": 0.05867637145561868}, "receipt_sha256": "389fe89d49d59ce1783179cfc5247536cce128a89099072ee0c06402a5525476"}],
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-PHASEON_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 9, "completed_epochs": 10, "average_mAP": 0.2560878632866976, "verified_at": "2026-09-08T19:07:42+08:00", "ema_all_finite": True, "identity_matches": True},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
    ]
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {"checked_at_cst": "2026-09-08 19:06 CST", "public_gpu_available": 0, "public_gpu_total": 200, "gpu_count_basis": "排除DOWN/DRAIN/FAIL/MAINT/RESERVED/NOT_RESPONDING后可见节点CfgTRES200、AllocTRES200；公共未分配不等于账户配额", "user_jobs_in_queue": 8, "account_constraint": "6 RUNNING/2 PENDING；两个PENDING均JobHeldUser。本任务五项仍RUNNING，其他任务不操作。磁盘剩余160.0GiB。五项新最佳EMA真实权重及对应轮次收据一致，尚无新epoch59终态"},
        ...
        "heartbeat_evidence": "31_HEARTBEAT_EVIDENCE_20260908_1904.json",
        "performance_cause_audit_scope": "2026-09-08 19:06-19:10实际核查：ET第15轮ON/OFF为42.1020%/42.7081%，H65第10轮均匀/相位关/四相开为30.9742%/30.8467%/25.6088%。五个新最佳EMA实际文件及对应轮次收据一致；所有成绩是测试参与选模的中期结果，无新终态或新增失败。本轮未调参、未重提、未重复准入；其他四路线缺失项未被掩盖",
