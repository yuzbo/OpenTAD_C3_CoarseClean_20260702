...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 21:31 CST：629162cd的均匀/相位关/四相开1280127/1280128/1280129均RUNNING；第25轮全测试56.7257%/55.8911%/49.1838%，最佳均第25轮。实际更新审计2500/2500/2600，AMP skip 3/4/5均已replay、耗尽0。另任务96e5b3a5的历史30+60匹配控制已排队，单独列示，不混入本60轮测试选模比较",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 21:31 CST：G0/G1训练及独立评测仍COMPLETED，官方Avg-mAP64.2720%/61.6740%未变，两个终态文件和收据stat/数值与前次一致。复用此前实际6000更新与receipt认证，不重复加载或评测。后续机制矩阵的eval5仍待接入",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 21:31 CST：793c4f9c旧正式门禁代码仍clean；另一任务0fcef0bf已修384插值检测轴与原始时间长度元数据，本地clean但未见GitHub分支。D1/F11/H0/G10/G11仍BLOCKED_UNIMPLEMENTED，不能把接线修复当作Taylor/H65机制完成。分钟轮询新鲜但dispatcher仍plan/BLOCKED",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 21:31 CST：710ce8a6的teacher/G96/U16/LATE/NOKD五个epoch59文件未变，仍无新独立metrics；FULL只有PRECHECK。另任务已提交本地padding修复b142bffa，详见新增独立行；不是padding仍完全无人修复，但该SHA未见GitHub分支或生产CUDA/PRECHECK/正式结果。本任务未操作历史1267920/1267921",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 21:31 CST：9a346f0d新ON1280117/OFF1280118均RUNNING。ON第40轮最佳55.3617%，OFF第35轮最佳62.5093%；同第35轮ON55.3159%比OFF低7.1934点，仍是中期而非新终态。五轮全测试、实际最佳EMA和收据均核验通过，无新fatal",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 21:31 CST：ce767b4d的A1/A6/F终态文件未变，A1官方51.5968%，F/A6仍缺独立receipt。另一任务新79aea08a已修基础scout监督开关、时间conditioner梯度与有效support接线，本地clean但GitHub未见分支；不是完整utility/robust/cycle实现，也尚无新正式性能",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 21:31 CST：另一任务PRECHECK1280306=PENDING/Priority；有符号归因1280314和原控制/整窗TIA1280316=PENDING/afterok:1280306。远端96e5b3a5 exact/clean，暂无stdout/stderr，尚未开训",
            "result_status": "已排队，无新性能；独立历史复现协议",
            ...
            "next_action": "由原任务在GPU准入通过后执行已排队三臂，补GitHub发布与完整验证证据；监督只读收集，不重复提交、不热改",
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {"checked_at_cst": "2026-09-08 21:31 CST", "public_gpu_available": 0, "public_gpu_total": 200, "gpu_count_basis": "本轮scontrol可见非DOWN/DRAIN/NOT_RESPONDING节点CfgTRES/AllocTRES；公共未分配不等于账户配额", "user_jobs_in_queue": 16, "account_constraint": "6 RUNNING/10 PENDING。本任务五项RUNNING；另一任务H65历史匹配预检和两项后续链仍等待Priority/Dependency，不取消其他项目腾资源。磁盘剩余148.9GiB。五个新最佳EMA真实权重通过，无新epoch59终态"},
        ...
        "heartbeat_evidence": "32_HEARTBEAT_EVIDENCE_20260908_2129.json",
        "performance_cause_audit_scope": "2026-09-08 21:31实际核查：ET-TRC ON第40轮最佳55.3617%、OFF第35轮最佳62.5093%；同第35轮ON低7.1934点。H65第25轮均匀/相位关/四相开为56.7257%/55.8911%/49.1838%。五个最佳EMA与收据一致，仍是测试参与选模的中期结果。补录另一任务四个本地修复分支，标明GitHub未发布、独立90轮协议和未完成机制。本轮无新增正式提交、参数调整或实际运行失败",
