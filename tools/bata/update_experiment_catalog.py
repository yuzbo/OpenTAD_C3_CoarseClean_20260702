...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 17:39:58 CST：新629162cd的正式1280127/1280128/1280129均RUNNING，已进入epoch2即第3轮训练。CUDA51tests和三组PRECHECK由1280125通过；每五轮全测试集选最佳EMA，允许测试集调参并披露。旧六臂结果保留原身份",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 17:39:58 CST：新ON1280117/OFF1280118均RUNNING，已分别于17:37:04/17:37:11在完成第5轮后实际进入完整测试评测，尚未返回完整mAP。不是仅配置启用；新协议标记及211视频/792窗口已核对，无新增报错",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 17:39:58 CST：1280117 RUNNING；2 GPU。完成第5轮后已实际开始完整测试；37tests及真实2GPU PRECHECK通过",
            "result_status": "正在首次第5轮完整测试",
            "final_result": "首轮全测试集mAP尚未返回。后续按完整官方Avg-mAP选择最佳EMA并允许测试集调参；另列epoch59 EMA/6000次更新的终态分数，不称独立未见测试泛化",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 17:39:58 CST：1280118 RUNNING；2 GPU。完成第5轮后已实际开始完整测试；37tests及真实2GPU PRECHECK通过",
            "result_status": "正在首次第5轮完整测试",
            "final_result": "首轮全测试集mAP尚未返回。后续按完整官方Avg-mAP选择最佳EMA并允许测试集调参；另列epoch59 EMA/6000次更新的终态分数，不称独立未见测试泛化",
            "next_action": "每5轮保存完整官方测试曲线与当前最佳EMA，后续按测试结果调整超参数并留存全部尝试；每30分钟汇总。失败先读日志、独立修复并新身份重提"
        },
        {
            ...
            "deployment_status": "2026-09-08 17:39:58 CST：1280127 RUNNING；1 GPU。已进入epoch2（第3轮）；1280125的CUDA51tests及对应PRECHECK通过",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 17:39:58 CST：1280128 RUNNING；1 GPU。已进入epoch2（第3轮）；1280125的CUDA51tests及对应PRECHECK通过",
            "result_status": "新实验尚无全测试集结果",
            "final_result": "未到首次第5轮全测试评测；不把初期loss或旧SHA成绩作为新性能。选择最佳EMA并允许测试集调参，终态epoch59 EMA/6000实际更新另列，不称未见测试集泛化",
            "next_action": "每5轮保存完整官方测试曲线与当前最佳EMA，后续按测试结果调整超参数并留存全部尝试；每30分钟汇总。失败先读日志、独立修复并新身份重提"
        },
        {
            ...
            "deployment_status": "2026-09-08 17:39:58 CST：1280129 RUNNING；1 GPU。已进入epoch2（第3轮）；1280125的CUDA51tests及对应PRECHECK通过",
            "result_status": "新实验尚无全测试集结果",
            "final_result": "未到首次第5轮全测试评测；不把初期loss或旧SHA成绩作为新性能。选择最佳EMA并允许测试集调参，终态epoch59 EMA/6000实际更新另列，不称未见测试集泛化",
            "next_action": "每5轮保存完整官方测试曲线与当前最佳EMA，后续按测试结果调整超参数并留存全部尝试；每30分钟汇总。失败先读日志、独立修复并新身份重提"
        },
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "performance_cause_audit_scope": "2026-09-08用户交互任务：完成H65整窗TIA与ET anchor修复、两份推送SHA、真实验证及五项正式部署；落实每五轮全测试、最佳EMA和测试集调参授权。17:39:58五项均RUNNING，ET两组完成第5轮后已实际开始完整测试，H65到epoch2，尚无新完整mAP。其他四路线未在本次完成新修复，不虚报六路线全完成",
