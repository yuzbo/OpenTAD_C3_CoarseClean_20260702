...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "deployment_status": "真实 CUDA/focused 门禁 1267855 已通过；D160 seed 4407 教师 1267884 正在运行，已到 epoch 9/update 1000 并保存 checkpoint；成功后按分钟提交 G96、U16、LATE、NOKD、FULL",
        ...
        },
        {
            ...
            "result_status": "C0 已完成前两个严格 epoch，尚无终态性能",
            "final_result": "审计在 epoch 1 显示 available 219/exposed 100、successful/EMA/scheduler updates 均为 200、selector schedule 为 0，loss 有限；尚无 epoch-59 EMA 或 official mAP",
