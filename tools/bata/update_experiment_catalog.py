...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 22:22 CST：629162cd三组仍RUNNING，第30轮全测试均匀/相位关/四相开60.7207%/60.2283%/52.6773%，最佳均第30轮。审计3000/3100/3200成功更新，AMP skip累计3/9/6，耗尽0；相位关在epoch29 batch74连续4次重试后恢复。另一任务历史30+60匹配预检已通过，两个正式作业22:01启动，独立列示",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 22:22 CST：G0/G1训练及独立评测仍COMPLETED(0:0)，64.2720%/61.6740%未变，终态stat及metrics与21:31一致。复用真实6000更新与receipt认证，不重复加载或评测。G2/G3旧身份保留，后续机制矩阵eval5仍待接入",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 22:22 CST：旧793c4f9c及后继0fcef0bf时间轴修复本地身份未变，后继仍未见GitHub分支。真实Taylor P0/P1、合法one-swap、H65 retention/transition仍未完成，无正式性能。分钟轮询新鲜、dispatcher仍plan/BLOCKED",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 22:22 CST：710ce8a6五份6000更新终态未变，新独立metrics仍0，FULL仅PRECHECK。另一任务padding修复b142bffa本地clean/未见GitHub分支，无新的生产验证或性能证据；screen与eval5缺项保留。历史1267920/1267921未操作",
        ...
        },
        {
            ...
            "scientific_audit": "仍为fixed-stride anchors加共享rank64可学习代理，不是精确anchor-dependent Jacobian或真实event gate。旧版本anchor correction污染已由9a346f0d屏蔽修复，非中心tap、跨视频和梯度回归通过；新OFF/ON实际2GPU、global batch2、FP32。已产生第5/10轮中期结果，尚无新终态性能，不声称70%节省或无损",
            ...
            "current_cycle": "2026-09-08 22:22 CST：ON1280117/OFF1280118均RUNNING；新增ON第45轮55.2871%、OFF第40轮62.4262%，均未超过已有best。因此ON保持第40轮55.3617%，OFF保持第35轮62.5093%，没有错误地用最新覆盖最佳。ON正在第50轮完整测试、OFF已进入epoch44；旧最佳实际权重认证复用，无新终态",
        ...
        },
        {
            ...
            "current_cycle": "2026-09-08 22:22 CST：旧A1/A6/F终态与A1独立收据未变，A1仍51.5968%，F/A6缺独立receipt。另一任务79aea08a接线修复本地clean/未见GitHub分支，utility/真实two-view/cycle/eval5及生产验证仍未完成；未冒称新正式性能",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 22:22 CST：1280118 RUNNING；全测试已返回第40轮，最佳仍按未四舍五入Avg-mAP选第35轮。最佳未变，复用21:31已认证实际EMA，不重复加载；exact/clean，无新增运行失败",
            "result_status": "中期测试选模结果（最新评测4000/6000 updates，最佳在第35轮）；尚无终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 4.2952%；第10轮 33.7828%；第15轮 42.7081%；第20轮 53.8420%；第25轮 59.5824%；第30轮 62.0582%；第35轮 62.5093%；第40轮 62.4262%；当前最佳第35轮 62.5093%，对应mAP@0.7为41.1250%。最佳未变，复用21:31已认证实际EMA，不重复加载。新周期及best收据自哈希通过；终态epoch59 EMA另报，不称独立未见测试泛化",
        ...
        },
        {
            ...
            "deployment_status": "2026-09-08 22:22 CST：1280129 RUNNING；全测试已返回第30轮，最佳仍按未四舍五入Avg-mAP选第30轮。本轮实际读取新最佳EMA，有限值及身份匹配；exact/clean，无新增运行失败",
            "result_status": "中期测试选模结果（最新评测3000/6000 updates，最佳在第30轮）；尚无终态",
            "final_result": "尚无终态结果。完整THUMOS14测试集211视频/792窗口的Avg-mAP：第5轮 4.9665%；第10轮 25.6088%；第15轮 32.4714%；第20轮 43.3471%；第25轮 49.1838%；第30轮 52.6773%；当前最佳第30轮 52.6773%，对应mAP@0.7为28.9148%。本轮实际读取新最佳EMA，有限值及身份匹配。新周期及best收据自哈希通过；终态epoch59 EMA另报，不称独立未见测试泛化",
            ...
            "best_test_checkpoint": {"path": "/data/run01/sczc063/yuzibo/experiments/h65_tia_eval5_629162cd_seed3407/formal/TEST-PHASEON_seed3407/gpu1_id0/test_guided/best_test.pth", "epoch": 29, "completed_epochs": 30, "average_mAP": 0.5267727933513344, "verified_at": "2026-09-08T22:22:24+08:00", "ema_all_finite": True, "identity_matches": True, "verification_reused": False},
            "test_guided_hyperparameter_trials": [],
            "next_action": "继续每5轮完整测试，记录当前最佳EMA和曲线；不因早期低分重启训练。本轮未改超参数，未来按测试结果调参时保留全部尝试、源代码和终态分数。每30分钟汇总，失败先读日志修复",
        },
        {
            ...
            "deployment_status": "2026-09-08 22:22-22:24 CST：另一任务PRECHECK1280306 COMPLETED(0:0)，原始日志28 passed及control/signed/fulltia三配置真实GPU三batch完成。signed1280314和control/fulltia链1280316于22:01:16启动，均RUNNING；当前链日志仅见control，尚未见fulltia正式启动。96e5b3a5远端exact/clean",
            "result_status": "两个正式作业已开训，无新性能；独立历史复现协议",
            "final_result": "共享30轮Stage-1 epoch29 EMA，重新初始化optimizer执行60轮Stage-2。当前配置以epoch59 EMA为主结果，每五轮测试仅记录曲线；不同于本任务strict60测试集选best实验。不得混合9000总更新与6000总更新的比较",
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {"checked_at_cst": "2026-09-08 22:22 CST", "public_gpu_available": 7, "public_gpu_total": 200, "gpu_count_basis": "排除DOWN/DRAIN/FAIL/MAINT/RESERVED/NOT_RESPONDING后可见节点CfgTRES200、AllocTRES193；公共余量不代表账户配额", "user_jobs_in_queue": 15, "account_constraint": "11 RUNNING/4 PENDING；本任务五项RUNNING，另一任务H65两个作业22:01开训；其他项目不操作。磁盘143.1GiB。首轮SSH连接关闭后已按原配置恢复，非训练失败"},
        ...
        "heartbeat_evidence": "33_HEARTBEAT_EVIDENCE_20260908_2215.json",
        "performance_cause_audit_scope": "2026-09-08 22:22实际核查：H65第30轮均匀/相位关/四相开60.7207%/60.2283%/52.6773%；三份新best实际EMA通过。ET新增第45/40轮没有超过既有best，继续保留ON第40轮55.3617%、OFF第35轮62.5093%，复用未变权重认证。历史H65匹配预检28tests与三配置GPU训练通过、两个正式作业已启动。SSH首轮关闭后恢复，无新增模型失败/终态/调参",
...
def md_text(payload: dict[str, Any]) -> str:
    ...
    lines += [
        ...
        "## 监督器与动态状态",
        "",
        f"远端 N16R4 监督器恢复目录：`{REMOTE_ROOT}`，每60秒轮询；本地heartbeat每30分钟刷新本表并用中文详细通知用户，即使无变化。当前回执状态：`{payload['remote_supervisor'].get('status')}`，距生成`{payload['remote_supervisor'].get('receipt_age_seconds', '未知')}`秒；dispatcher：`{payload['remote_supervisor'].get('dispatcher_status', '未知')}`，mode：`{payload['remote_supervisor'].get('dispatcher_mode', '未知')}`。旧进程因磁盘配额退出的日志保留；新进程恢复只读轮询，超过180秒标STALE。dispatcher不自动续提当前修复队列。17:21/17:26由监督任务提交的5项新协议正式训练继续运行，见独立行和29号部署记录；本轮只核查中期曲线与最佳EMA，见33号记录，未新增提交、取消或改参。不是分钟dispatcher自动提交。已有Computer Use初始化阻塞仍保留，本轮未咨询Pro，也未取消旧任务。",
        "",
