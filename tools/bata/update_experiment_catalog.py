...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "deployment_status": "远端 exact-SHA admission 1267684 已通过；REF-D768、REF-U384、REF-MNV3FC384 正式训练 1267709/1267711/1267737 均 COMPLETED(0:0)。D768 官方评测 1269303 与 U384 修复后评测 1269360 均 COMPLETED(0:0) 并写出独立 metrics receipt；MNV 评测 1269373 已由 watcher 提交并 RUNNING。F01 1269287、F02 1269291、F03 1269341 均在课程切换附近因相同 p_action calibration 异常失败，依赖评测 1269288/1269292/1269342 已取消。三个不同 F 臂复现后已停止旧 e553a5a4 F04-F06 训练 1269358/1269361/1269367 及依赖评测，保留日志和 checkpoint，并停止旧矩阵提交器 PID 2223883。修复 codex/h65-pro-paction-tolerance-repair-20260904@30514803 已推送并通过远端 23 tests；新 watcher PID 603973 已使 F01-F04 PRECHECK 1269372/1269376/1269378/1269380 全部 PASS，正式重训 1269375/1269377/1269379/1269381 均 RUNNING，F05/F06 将按同一规则续提",
            "result_status": "D768 与 U384 两臂官方终态性能有效；MNV 官方评测运行中；旧 F01-F03 同源失败，F01-F04 已在修复 SHA 上通过准入并重训",
            "final_result": "D768 official THUMOS14 validation Avg-mAP=67.58%，mAP@0.3/0.4/0.5/0.6/0.7=82.56/78.12/69.98/60.37/46.88%。U384 Avg-mAP=63.89%，对应 79.37/74.83/67.15/55.94/42.18%，比 D768 低 3.69 个 Avg-mAP 百分点、mAP@0.7 低 4.70 点；U384 receipt 绑定 evaluator 67c8f39f、训练 e553a5a4、seed 3407、epoch 59 EMA、6000 updates、211 videos/422000 predictions。MNV 指标尚未生成；30514803 已通过逐臂准入并实际开始重训，但尚未跨越旧作业的 epoch 20-23 故障区间",
            "next_action": "监控 MNV 评测和修复版 F01-F04；watcher 继续提交 F05/F06，所有修复臂跨越原故障区间并完成终态后再运行独立评测",
        },
        {
            "category": "correction_route",
        ...
        },
        {
            ...
            "deployment_status": "真实 CUDA/focused 门禁 1267855 已通过；D160 教师 1267884、G96 1268698、U16 1269124、LATE 1269129、NOKD 1269137、FULL 重试 1269297 均 COMPLETED(0:0)，全部写出 6000-update epoch-59 receipt。新 screen receipt screen_receipt_r2_1269297.json 精确绑定成功的 FULL 重试并由仓库 finalizer 提升为 PASS，原失败 1269284 仍单独保留。首次五臂评测 1269382 因嵌套脚本误用 SLURM_SUBMIT_DIR 在 2 秒内失败，未触碰 checkpoint；显式导出 exact PROJECT_DIR 后重试 1269383 已加载 G96 checkpoint 并开始处理 792-window validation",
            "result_status": "D160 与五个 screen 臂训练终态有效，screen gate PASS；seed 4407 五臂官方评测运行中，尚无开放性能",
            "final_result": "FULL receipt 绑定 539287fa、seed 4407、world_size 2、6000 successful updates、D160 teacher 和 checkpoint SHA256=c0eb8677…；五臂 screen receipt 状态 PASS。现有训练 receipt 的 eval_results 仍为空且 metric_opened=false，1269383 完成 prediction 与 metric-opening receipts 前不得报告 mAP",
            "next_action": "监控 1269383 依次完成 G96、U16、LATE、NOKD、FULL 的 prediction-only 与 official metric opening；失败时按当前臂日志最小修复并从新作业重提",
        },
        {
            "category": "correction_route",
        ...
        },
        {
            ...
            "deployment_status": "旧 77c8d173 C0 训练 1267979 虽完成 6000 updates，但评测 1269325 发现 test loader 的 792 次暴露没有被旧 487-row ledger 覆盖，因此该训练只保留为诊断并从正式比较中取代。第一次 full-grid 修复 1269354 又暴露 train loader 438 与 full-grid train ledger 470 的拓扑不符；第二次 1269356 暴露覆盖检查器未接受 ledger loader 归一化后的 NumPy ndarray。最终 codex/duca-evidence-fullgrid-repair-20260904@246058f2 使用 train/val 精确旧网格与 test full-grid，强制 allow_missing=False 并按唯一物理窗口校验；admission 1269357 COMPLETED(0:0)，验证 train 438/438、val 487/487、test 792 exposures/791 unique/791 ledger，34 tests 与 CUDA FP32 gate 均通过。新 C0 seed 8261 作业 1269374_0 已获得 GPU，完成 epoch 0 并进入 epoch 1；一次 AMP skip 已按 20-replay 合同恢复，当前无异常",
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_observation": {
            "checked_at_cst": "2026-09-04 05:14:07 CST",
            "public_gpu_available": 117,
