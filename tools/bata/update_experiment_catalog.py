...
def route_entries() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "deployment_status": "远端 exact-SHA admission 1267684 已通过；REF-D768、REF-U384、REF-MNV3FC384 正式训练 1267709/1267711/1267737 正在运行，依赖评估 1267710/1267712/1267738 等待",
            "result_status": "正式训练进行中，尚无终态性能",
            "final_result": "已修复短窗口 padding 后 K=383 与输入 K=384 不一致；本地 32 passed、远端 admission 成功，当前无 epoch-59 EMA 或官方 mAP",
        ...
        },
        {
            ...
            "result_status": "四臂正式训练进行中，尚无终态性能",
            "final_result": "远端 26 项测试与 CUDA 几何/梯度门禁通过；当前训练 loss 有限，尚无 epoch-59 EMA 或官方 mAP",
        ...
        },
        {
            ...
            "deployment_status": "真实 CUDA/focused 门禁 1267855 已通过；按分钟等待队列名额后启动 D160 教师，再依次提交 G96、U16、LATE、NOKD、FULL",
            "result_status": "教师尚未成功训练，学生五臂尚未提交，无终态性能",
        ...
        },
        {
            ...
            "result_status": "双臂正式训练进行中，尚无终态性能",
            "final_result": "当前训练 loss 有限；ET-TRC 保持 100% dense temporal states，只减少 Transformer 块内完整计算次数",
        ...
        },
        {
            ...
            "sha": "0d1abf6dc0b3b5f13c1f18118e0689af32d84229",
            "github_commit": "https://github.com/yuzbo/OpenTAD_C3_CoarseClean_20260702/commit/0d1abf6dc0b3b5f13c1f18118e0689af32d84229",
            "local_directory": "E:/DeskTop/TAD/OpenTAD_Evidence_FormalRepair_20260903",
            "deployment_status": "修复后 admission 1267834 为 28 passed 且 CUDA 门禁通过；C0 seed 8261 训练 1267857 正在运行，评估 1267858 等待",
            "result_status": "C0 正式训练进行中，尚无终态性能",
            "final_result": "保留 1267747 的 219-vs-100 loader 合同失败；0d1abf6d 改为每 epoch 确定性暴露 100 batch、共 6000 成功更新",
            "next_action": "先确认 C0 完成首个 100-update epoch，再逐步释放其余七个消融臂",
        },
    ]
...
def catalog() -> dict[str, Any]:
    ...
    return {
        ...
        "excluded_remote_jobs": [
            ...
            {"job_ids": "1267747,1267748", "remote_directory": "/data/run01/sczc063/yuzibo/projects/duca_evidence_formal_21d1d229", "source_head": "21d1d22975686852d0c1dc31a0f62419252f17d4", "reason": "Evidence C0 首次正式启动因 DataLoader 219 batches 与 100-update 合同实现冲突而失败；0d1abf6d 已修复并用 1267857/1267858 新 namespace 重提"},
