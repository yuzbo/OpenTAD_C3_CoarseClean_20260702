...
from tools.bata.validate_duca_must_dynamic_official_adatad_backend import validate_config as validate_must_config


CONFIG_DEFAULT = "configs/adatad/thumos/duca_must_dynamic_x3d_official_adatad_backend_full_train.py"
