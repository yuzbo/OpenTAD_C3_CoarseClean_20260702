...
def validate_config(
    ...
    *,
    ...
    _require(
        ...
        "main config must declare transition/boundary/utility-first selector scoring",
    )
    _require(
    ...
    _require(
        ...
        "main config must not claim true detector-derived utility for the GT boundary proxy",
    )
    ...
    if require_online_c3_actionness:
        ...
        _require(
            ...
            "main DUCA selector must enable temporal max-gap loss",
        )
