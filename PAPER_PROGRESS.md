...
- **ordered-video reuse 执行状态：** 最小 clean/pushed candidate 为 [GitHub exact commit `6139e793e530033e2af6d992819cbe327d5bbd86`](https://github.com/yuzbo/OpenTAD_C3_CoarseClean_20260702/commit/6139e793e530033e2af6d992819cbe327d5bbd86)，focused tests `8 passed`，修复首轮 Critic 的 evaluator exactness 与 frame-index identity 两项 blocker 后，fresh re-Critic `PASS`、fresh result-blind Evaluator `PRE_RUN_READY`。非科学 precheck job `1262717` 已 `COMPLETED 0:0 / PRECHECK_READY`，完整核验 211 videos/792 windows 的 legacy-vs-rolling pre-H2D tensor、mask、metadata 与 frame-index exact parity。唯一 formal job `1262753` 已以 1 GPU、6 CPU、16h 提交并在 `g0030` 启动，submission `1/1`；终态前不读取 partial 结果。
