...
- **GridFuse32-L6 G0 终态与唯一下一动作：** latest clean/pushed implementation 为 [GitHub exact commit `dde46aee17f10bf793e5407055fc7b3416d93205`](https://github.com/yuzbo/OpenTAD_C3_CoarseClean_20260702/commit/dde46aee17f10bf793e5407055fc7b3416d93205)。唯一 job `1262108` 完成真实 `B1/T384/K64/N24576` full-window construction、冻结 ledger、100 warmups/arm、500 alternating samples/arm 与显存测量；dense/candidate p50 为 `178.500099/314.885696 ms`，speedup `0.56687268x` 未通过 `>=1.35x`，allocated/reserved ratio 均为 `1.0`。终态是 `STOP_GRIDFUSE32_L6_EXACT_ROUTE_VALID_G0_NEGATIVE`，不是执行 blocker；不修复、不重跑、不开 G1/G2。唯一下一动作是携带 repository、branch、exact commit 链接和完整终态证据的一次 fresh exact-Project Pro 独立裁决。
