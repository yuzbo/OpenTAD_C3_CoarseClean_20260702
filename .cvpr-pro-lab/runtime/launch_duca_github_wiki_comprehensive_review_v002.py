#!/usr/bin/env python3
"""Launch one exact-DUCA Pro turn using public GitHub Wiki and code links."""
...
PROMPT = ROOT / ".cvpr-pro-lab/pro-reviews/prompts/PRO_DUCA_GITHUB_WIKI_COMPREHENSIVE_REVIEW-v002.md"
...
RUN_DIR = ROOT / ".cvpr-pro-lab/pro-reviews/runs/duca-github-wiki-comprehensive-review-v002"
ORACLE_HOME = ROOT / ".cvpr-pro-lab/oracle/duca-github-wiki-comprehensive-review-v002"
...
def main() -> int:
    ...
    transport_prompt = (
        "Read the single supplied review task completely, then open and inspect every required public GitHub Wiki and exact "
        "code-version URL yourself. Do not treat the task file as a source bundle. Preserve nonce "
        f"{NONCE} verbatim and end exactly with DUCA_GITHUB_WIKI_COMPREHENSIVE_REVIEW_READY."
    )
    ...
    manifest = {
        ...
        "transport": "ONE_INLINE_REVIEW_TASK_NO_WIKI_OR_CODE_ATTACHMENTS",
    ...
    with contextlib.ExitStack() as stack:
        ...
        command = [
            ...
            "--force",
            "--verbose",
            "--slug", "duca-github-wiki-comprehensive-review-v002-transport4",
    ...
    terminator_bound = report_text.rstrip().endswith("DUCA_GITHUB_WIKI_COMPREHENSIVE_REVIEW_READY")
    complete = bool(
        return_code == 0
