#!/usr/bin/env python3
"""Launch one fresh exact-DUCA project-level Pro adjudication after Marginal-v1 STOP."""
...
WORKTREE = Path(
    r"C:\Users\skywalker\.codex\worktrees\duca-marginal-cap-release-falsifier-v1-20260831"
    r"\OpenTAD_C3_CoarseClean_20260702"
)
PROMPT = ROOT / ".cvpr-pro-lab/pro-reviews/prompts/PRO_DUCA_PROJECT_LEVEL_AFTER_MARGINAL_STOP-v001.md"
...
LATEST_COMMIT = "46812facc8773d9b4a9c21833cbe397c8aaa5a2d"
LATEST_BRANCH = "feature/duca-marginal-cap-release-neighborhood-falsifier-v1-20260831"
RUN_DIR = ROOT / ".cvpr-pro-lab/pro-reviews/runs/duca-project-level-after-marginal-stop-v001"
ORACLE_HOME = ROOT / ".cvpr-pro-lab/oracle/duca-project-level-after-marginal-stop-v001"
...
MATERIALS = (
    ...
    ROOT / "research-wiki/experiments/duca-marginal-v1.md",
    ROOT / ".cvpr-pro-lab/pro-reviews/runs/duca-marginal-cap-release-neighborhood-terminal-compact-v002/visible-report.md",
)
GITHUB = {
...
def main() -> int:
    ...
    with contextlib.ExitStack() as stack:
        ...
        command = [
            ...
            "--wait",
            "--verbose",
            "--slug", "duca-project-level-after-marginal-stop-v001",
            "--write-output", str(visible_report),
            "--prompt",
            (
                "Read every provided file completely and answer the authoritative prompt as one independent project-level "
                "scientific adjudication. Treat the repository, actual remote branch, exact commit "
                f"{LATEST_COMMIT}, runner, allocator and test permalinks in the prompt as the latest code truth. "
                "This is a fresh scientific question, not a Marginal-v1 recovery or follow-up. "
