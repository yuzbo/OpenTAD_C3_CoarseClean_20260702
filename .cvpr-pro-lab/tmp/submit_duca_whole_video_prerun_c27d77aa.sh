...
#SBATCH --qos=normal
#SBATCH --job-name=duca-whole-pre
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --gpus=1
#SBATCH --time=04:00:00
#SBATCH --chdir=/data/run01/sczc063/yuzibo/duca_whole_video_c27d77aa_20260831
#SBATCH --output=/data/run01/sczc063/yuzibo/duca_whole_video_result_c27d77aa_20260831/pre-run-slurm-%j.out
#SBATCH --error=/data/run01/sczc063/yuzibo/duca_whole_video_result_c27d77aa_20260831/pre-run-slurm-%j.err

source /etc/profile
set -euo pipefail

DUCA_BASE=/data/run01/sczc063/yuzibo
DUCA_SNAPSHOT="$DUCA_BASE/duca_whole_video_c27d77aa_20260831"
DUCA_INPUT="$DUCA_BASE/duca_marginal_summary_f67d96fd_20260831"
DUCA_OUTPUT="$DUCA_BASE/duca_whole_video_result_c27d77aa_20260831"
DUCA_HEAD=c27d77aafd4aa514def033b03f2dfc2d6c24771e
...
python -m py_compile tools/bata/run_duca_whole_video_consistent_budget_falsifier.py
python -m pytest \
  tests/test_duca_marginal_budget.py \
  tests/test_duca_whole_video_consistent_budget_falsifier.py \
  -q
