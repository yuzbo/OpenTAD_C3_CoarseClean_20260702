...
#SBATCH --output=/data/run01/sczc063/yuzibo/duca_whole_video_result_33e4ed13_20260831/pre-run-slurm-%j.out
#SBATCH --error=/data/run01/sczc063/yuzibo/duca_whole_video_result_33e4ed13_20260831/pre-run-slurm-%j.err
